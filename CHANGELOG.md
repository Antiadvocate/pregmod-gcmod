...
## 0.10.7.1-4.0.0-alpha.38 - 2025-08-28

* Stewardess now sexually manages her underlings
* small improvements to subordinate slaves
* fixes
* webGL breast size made more accurate

## 0.10.7.1-4.0.0-alpha.37 - 2025-08-19

* WARNING - FCHost users need to update or rebuild FCHost before running alpha.37 or it WILL DELETE YOUR LOCAL SAVES!!! Download info is at https://gitgud.io/pregmodfan/fc-pregmod/-/blob/pregmod-master/FCHost/README.md?ref_type=heads#fchost and build info is at https://gitgud.io/pregmodfan/fc-pregmod/-/blob/pregmod-master/FCHost/HowToBuild.md#how-to-build
...
* added new clothing (slave rags, slutty magical girl)
* tweaked HG surgery tastes
* more RA breast surgery rules
* Family tree and family tracking better handles missing slaves
* fixes

## 0.10.7.1-4.0.0-alpha.36 - 2025-06-30
...
## 0.10.7.1-4.0.0-alpha.33 - 2024-09-18
...
* possibly fixed the slave is own niece thing
 ...
 58
* incestuous relationships extended to player's mother, father and sisters

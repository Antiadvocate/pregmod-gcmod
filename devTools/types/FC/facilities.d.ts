declare namespace FC {
	...
	interface IFacilityAssignment {
		...
		partTime?: boolean;
		/** Aspects controlled by the facility, regardless of upgrades/rules */
		commonControlledAspects: Facilities.FacilityControlledAspect[];
	}
	...
	type FacilityControlledAspect = "rest" | "livingRules" |
		"clothes" | "collar" | "faceAccessory" | "mouthAccessory" | "vaginalAccessory" | "vaginalAttachment" | "dickAccessory" | "buttplug" | "chastity" |
		"lactation" | "diet" |
		"aphrodisiacs" | "curatives"| "drugs" | "hormones" | "contraceptives" |
		"surgeryProstateImplant" | "surgeryVasectomy" | "surgeryHolesVirginity" |
		"surgeryLactationImplants" | "surgeryBoobsImplants" | "surgeryButtImplants" | "surgeryLipsImplants" |
		"surgeryHips" | "surgeryHeight" | "surgeryTendons" |
		"surgeryFaceShape" | "surgeryEyesPresence";

	interface FacilityControlledAspectFreeze extends Record<string, FacilityControlledAspect> {

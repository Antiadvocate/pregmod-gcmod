	...
	namespace Medicine {
		...
		namespace Surgery {
			...
			type SizingOptions<Target extends SizingImplantTarget> = {
				...
				replace?: boolean;
				facilityControlledAspects?: Set<FacilityControlledAspect>;
			}

			type DefinitiveSizedOptions<Target extends SizingImplantTarget> = Required<SizingOptions<Target>>;

			type Type =
				"skinTone" | "skinMarkings" |
				"restoreFace" | "faceUp" |
				"ageDown" | "ageUp" |
				"bracesOn" | "bracesOff" | "teeth" |
				"earShape" |
				"hornOn" | "hornOff" |
				"restoreVoice" | "voiceFeminine" | "voiceLessGirly" |
				"lipEnlargementImplant" | "lipEnlargement" | "lipReduction" |
				"lipoFull" | "lipoSuck" |
				"shouldersUp" | "shouldersDown" |
				"bellyUp" | "bellyDown" | "bellyDownHuge" |
				"bellyOut" |
				"waistUp" | "waistDown" |
				"hipsUp" | "hipsDown" |
				"fixHeels" |
				"breastReductionImplant" | "breastShrinkage" |
				"breastEnlargementImplant" | "breastEnlargement" |
				"breastImplantSwap" | "breastReconstruction" |
				"nippleReconstruction" | "areolae" | "breastMesh" |
				"flatChest" | "breasts" |
				"buttReductionImplant" | "buttShrinkage" |
				"buttEnlargementImplant" | "buttEnlargement" |
				"buttImplantSwap" |
				"ballEnlargement" | "ballShrinkage" |
				"ballEnlargementHorm" | "ballShrinkageHorm" |
				"ballBigShrinkage" |
				"internalBalls" | "removeBalls" | "replaceBalls" | "newBalls" |
				"scrotum" | "prostate" |
				"foreskinDown" | "circumcision" | "foreskinRestore" |
				"dickGone" | "newDick" |
				"vaginaGone" | "newVagina" |
				"analCleanup" | "rectum" |
				"tightPussy" | "reVirgin" | "replaceOvaries" |
				"clitDown" | "clitHood" |
				"labia" |
				"cervix" |
				"vasectomy" |
				"herm2female" | "herm2male" |
				"herm2truefemale" | "herm2truemale" |
				"male2female" | "male2herm" | "male2truefemale" |
				"male2hermfemale" |
				"female2male" | "female2herm" | "female2truemale" |
				"female2hermmale" |
				"tummyTuck" | "ovulationRestart";
		}
		namespace OrganFarm {

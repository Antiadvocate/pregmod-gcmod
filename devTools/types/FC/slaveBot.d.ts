declare namespace FC {
  namespace SlaveBot {
    // Spec from https://github.com/malfoyslastname/character-card-spec-v2/blob/main/spec_v2.md
    type TavernCardV2 = {
      spec: "chara_card_v2";
    ...
    /**
     * For FC, we will choose to support SillyTavern for compatibility. All other frontends will be best effort.
     *

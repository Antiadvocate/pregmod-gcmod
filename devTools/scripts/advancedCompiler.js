...
const args = yargs(hideBin(process.argv))
	...
	.option('called-by-watcher', {
		type: 'boolean',
		description: 'Should not be used directly, if true configure the compiler for the watcher',
		default: false,
	})
	.parse();
...
if (settings.compilerMode === "simple") {
	...
	if (settings.WatcherLiveReload === true && args.calledByWatcher) {

...
import {
  Building2, Users, Play, Landmark, ScrollText, ShoppingBag, ClipboardList, Settings as Cog, FileText, UserRound, Wand2, MoreHorizontal, Globe2, BookOpen, Scale, GitCompareArrows } from "lucide-react";
...
export type Route = "penthouse" | "people" | "story" | "scene" | "city" | "society" | "compare" | "arcology" | "doctrine" | "market" | "orders" | "report" | "you" | "cheats" | "settings";

...
export const POLICIES: Policy[] = [
  ...
  { id: "slave_courts", name: "Slave courts", group: "law", cost: 12000, weekly: -400,
    blurb: "A slave may bring a complaint against her holder, and most of them lose, though the ones who win get talked about for years.",
  ...
  { id: "manumission", name: "Manumission scheme", group: "law", cost: 15000, weekly: -600,
    blurb: "A published price at which a slave may buy herself out. Almost nobody ever reaches it, but having a number on the wall changes how the years feel.",
  ...
  { id: "sanitation", name: "Public sanitation", group: "civic", cost: 9000, weekly: -500,
    blurb: "Water, waste and filters, which is the half of a city nobody notices until it stops.",
  ...
  { id: "free_port", name: "Free port", group: "trade", cost: 18000, weekly: -200,
    blurb: "No tariff on anything passing through, because the volume it brings in more than covers what the tariff would have.",
  ...
  { id: "household_rations", name: "Cut household rations", group: "household", cost: 0, weekly: 600,
    blurb: "Feed them less than they need, which saves a genuinely useful amount of money.",
  ...
  { id: "rest_day", name: "One day off in seven", group: "household", cost: 0, weekly: -400,
    blurb: "Nobody works the seventh day, so it costs you roughly a seventh of everything they would have earned.",

...
export const DOCTRINES: Doctrine[] = [
  {
    ...
    creed: "Slaves should be well cared for, educated and treated kindly.",
    ...
    policies: [{ id: "rehab", name: "Rehabilitation clinics", note: "broken slaves recover faster", cost: 8000 }],
  },
  {
    id: "degradationist", noun: "Degradationism", adj: "Degradationist",
    creed: "Slaves are property and should be degraded and treated as such, publicly.",
  ...
  },
  {
    ...
    creed: "Slaves should be natural, without implants or cosmetic surgery.",
  ...
  },
  {
    ...
    creed: "Slaves' bodies should be surgically enhanced and transformed.",
  ...
  },
  {
    ...
    creed: "Young slaves are the most desirable.",
  ...
  },
  {
    ...
    creed: "Older, experienced slaves are the most desirable.",
  ...
  },
  {
    ...
    creed: "Slaves should be slim, with small breasts and narrow hips.",
  ...
  },
  {
    ...
    creed: "Slaves should have huge breasts, butts and other assets.",
  ...
  },
  {
    ...
    creed: "Gender is a matter of choice; dickgirls and surgically altered slaves are welcome.",
  ...
  },
  {
    ...
    creed: "Women are for bearing children and pleasing men.",
  ...
  },
  {
    ...
    creed: "Slaves should be strong, fit and muscular.",
  ...
  },
  {
    ...
    creed: "Slaves and citizens alike should indulge in food, comfort and pleasure.",
  ...
  },
  {
    ...
    creed: "Slaves should be milked, and the arcology should run on their products.",
    ...
    policies: [{ id: "milk_law", name: "Mandatory lactation", note: "all slaves must lactate", cost: 10000 }],
  },
  {
    id: "repopulation", noun: "Repopulation Focus", adj: "Repopulationist",
    creed: "Slaves should be kept pregnant to repopulate the world.",
  ...
  },
  {
    ...
    creed: "Only the elite should breed; everyone else should be kept from it.",
  ...
  },
  {
    ...
    creed: "Slaves should be highly skilled, educated professionals.",
  ...
  },
  {
    ...
    creed: "Slaves should be kept stupid and dependent on their owners.",
  ...
  },
  {
    ...
    creed: "Short, small slaves are the most desirable.",
  ...
  },
  {
    ...
    creed: "Tall slaves are the most desirable.",
  ...
  },
  {
    ...
    creed: "One race is superior and should rule over the others.",
  ...
  },
  {
    ...
    creed: "One race is inferior and should be enslaved.",
  ...
  },
  {
    ...
    creed: "Slaves of every race and nation are equally valued.",
  ...
  },
  {
    ...
    creed: "Slavery is holy, and slaves serve by divine will.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on ancient Rome.",
  ...
  },
  {
    ...
    creed: "The arcology should be ruled like a feudal kingdom, with you as its lord.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on ancient Egypt, and incest among the elite is sacred.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on Edo-period Japan.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on the old Arabian caliphates.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on imperial China, with exams and ministries.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on the Aztec Empire, including sacrifice.",
  ...
  },
  {
    ...
    creed: "The arcology should be modeled on the antebellum American South.",
  ...
  },
  {
    ...
    creed: "Everything is shared, and slaves' output belongs to the community.",
  ...
  },
  {
    ...
    creed: "Sex between family members is normal and encouraged.",

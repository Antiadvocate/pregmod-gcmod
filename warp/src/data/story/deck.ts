...
const journalist: ArcDef = {
  ...
  beats: {
    ask: {
      ...
      text: (c) => `${c.full("journalist")} writes for the Kestrel Ledger, which every member of the Owners' Association reads. ${c.He("journalist")} wants a week inside ${c.arcology}: the floors, the facilities, the household. "Warts and all," says the email. "People want to know how it actually works."
...
${c.He("journalist")}'s last piece was about an arcology in the Sahel. Its owner lost his seat on the Association a month later.`,
      options: [
        ...
        { id: "curated", label: "Give them a tour you've arranged", need: skill("slaving", 25),
          run: (c) => { c.set("jour_curated", true); c.cash(-3000);
            return { text: `You pick the rooms, the women, the hours. The dormitories get new sheets. The arcade is closed for maintenance. ${c.n("journalist")} obviously notices, but doesn't say anything.`, next: "piece", after: 2 }; } },
        { id: "refuse", label: "Decline",
          run: (c) => { c.like("journalist", -10);
            return { text: `You decline politely. ${c.n("journalist")} writes the piece anyway, from the outside, using your delivery records and three former citizens. It's unflattering and not very accurate.`, end: "you kept the journalist out" }; } },
    ...
    piece: {
      ...
      text: (c) => {
        return goodPiece(c)
          ? `The Ledger runs it over three pages. It's called "The Kind House". ${c.n("journalist")} quotes your women by name. They say good things about you, some of which surprise you.`
          : `The Ledger runs it over three pages. It's called "Inventory". ${c.n("journalist")} quotes your women by name, and what they say about you is brutal.`;
      },
      options: [
        ...
        { id: "sue", label: "Sue the paper", note: "¤8,000", need: cash(8000),
          ...
          run: (c) => { c.cash(-8000); c.rep(-100);
            return { text: `The suit keeps the story in the news for another month. You end up settling out of court, and look worse than before.`, end: "you sued over a bad piece and lost" }; } },
        { id: "punish", label: "Find out who talked, and deal with them",
          ...
          run: (c, p) => { if (!p) return { text: "" }; resolveAct(c.s, p, "discipline"); c.treat(p, "cruelty", 7, "punished for what she told the journalist"); c.household("coercion", 3, "saw what happened to the one who talked"); c.rep(-100);
            return { text: `You make an example of ${p.name} in front of the others. Nobody talks to a journalist again. Somehow the Ledger finds out and runs a follow-up about it.`, end: "you punished the one who talked" }; } },
        { id: "take", label: "Take the journalist", show: (c) => c.he("journalist") === "she", need: secure(45),
          run: (c) => { const p = c.addSlave({ seed: "journalist", name: c.full("journalist"), age: 33, quality: 0.4, how: "came to write about you and stayed as property", hostile: true }); c.npc("journalist").status = "owned"; c.npc("journalist").person = p.id; c.rep(-200); c.crime(2);
            return { text: `She's picked up on the concourse the night the piece runs. Officially she left on the evening ferry. Actually she's in your cellblock, demanding a lawyer she's never going to get.`, end: "the journalist is yours now" }; } },
        { id: "shrug", label: "Let it go",
          run: (c) => { c.rep(-200);
            return { text: `It's in the news for a week and then forgotten. Some of your citizens think less of you, and your slaves talk about it for a while.`, end: "you let the piece stand" }; } },
      ],
    },
  },
};
...
He doesn't talk about God much. He talks about you: what's on your floors, what you pay for it, and what the people who live under it are worth to you. Your security chief has a recording of him, and he's a very good speaker.`,
      options: [
        ...
        { id: "arrest", label: "Have him arrested for incitement", need: secure(40),
          run: (c) => { c.security(3); c.crime(4); c.standing(-1); c.set("zeal_martyr", true);
            return { text: `Four guards take him off his crate in front of seventy people. Nobody fights them. Everybody films it. By morning people have left flowers on his crate.`, next: "martyr", after: 3 }; } },
        ...
        { id: "buy", label: "Offer him a better crate", note: "¤5,000 a month to preach something else", need: cash(5000),
          run: (c) => { c.cash(-5000); c.set("zeal_bought", true);
            return { text: `He listens to the offer and laughs. "I'll take the money," he says. "I'll give it to the people downstairs. I'll still say what I say." You're now paying a man to insult you.`, next: "martyr", after: 4 }; } },
      ],
    },
    tea: {
      ...
      options: [
        { id: "chapel", label: "Build him a chapel on the lower levels", note: "¤12,000", need: cash(12000),
          run: (c) => { c.cash(-12000); c.prosperity(4); c.crime(-6); c.like("zealot", 30); c.npc("zealot").status = "ally";
            return { text: `It's a bare room with good light and nothing in it to buy. He preaches there now, and he's less angry. Crime from the lower levels go down, and some of your women ask to go on Sundays.`, end: "you built the preacher a chapel" }; } },
        ...
        { id: "free", label: "Offer to free one of your women if he'll stop",
          ...
          run: (c, p) => { if (!p) return { text: "" }; c.remove(p, "free", "freed as a gift to the preacher"); c.like("zealot", 25); c.hope(8); c.standing(2);
            return { text: `He's quiet for a long time, then stands up and shakes your hand. ${p.name} leaves the arcology with him, he preaches about it that Sunday, and he never mentions you by name again.`, end: "you freed a woman for the preacher" }; } },
      ],
    },
    martyr: {
      ...
      text: (c) => c.flag("zeal_martyr")
        ...
        : `Three hundred people on the concourse with candles. ${c.n("zealot")} stands on his crate in the middle of them and reads out the names of women in your household. He has every name right.`,
      options: [
        { id: "release", label: "Let him go, publicly",
          run: (c) => { c.standing(1); c.crime(-3); c.like("zealot", 15);
            return { text: `You open the cell yourself, with cameras there. The crowd goes quiet when he walks out. To your surprise he thanks you, and asks them to go home. Most of them do.`, end: "you released the preacher" }; } },
        { id: "disperse", label: "Clear the concourse", need: secure(50),
          run: (c) => { c.crime(8); c.standing(-3); c.rep(200); c.prosperity(-5); c.household("coercion", 2, "the night the concourse was cleared");
            return { text: `It takes forty minutes and there's blood on the tiles in the morning. The protests stop, but so does a lot of the concourse's business.`, end: "you cleared the preacher's crowd by force" }; } },
        { id: "exile", label: "Put him on a boat to somewhere else",
          run: (c) => { c.npc("zealot").status = "gone"; c.crime(2);
            return { text: `He goes without a fight. On the gangplank he turns and blesses the arcology. You can't tell whether he's being sarcastic.`, end: "you exiled the preacher" }; } },
      ],
    },
  },
};
      ...
      options: [
        { id: "sell", label: "Sell her", note: (c) => `+${money(valuePerson(c.s, c.subj!) * 3)}`,
          run: (c) => { const v = Math.round(valuePerson(c.s, c.subj!) * 3); if (c.subj) c.remove(c.subj, "sold", `sold to ${c.full("collector")} for three times her price`, v); c.like("collector", 20); c.hope(-4);
            return { text: `She goes on ${c.n("collector")}'s jet the next morning, in a dress ${c.he("collector")} brought for her. The money clears before the plane lands.`, end: "you sold her to the collector" }; } },
        { id: "no", label: "\"She's not for sale.\"",
          run: (c) => { c.like("collector", -15); c.treat(c.subj, "recognition", 7, "you refused three times her price for her");
            return { text: `"Everything is," ${c.n("collector")} says, and puts the card back in ${c.his("collector")} pocket. ${c.sn} is grateful that you kept her, and that night she comes to your room without being told to.`, next: "theft", after: 5 }; } },
        { id: "ask", label: "Ask her whether she wants to go",
          run: (c) => { const wants = c.subj ? read(c.subj).devotion < 10 : false; c.set("coll_asked", true);
            if (wants && c.subj) { const v = Math.round(valuePerson(c.s, c.subj) * 3); c.remove(c.subj, "sold", `chose to go to ${c.full("collector")}`, v); c.like("collector", 10);
              return { text: `She doesn't hesitate. "Yes." ${c.n("collector")} pays on the spot.`, end: "she chose the collector over you" }; }
            c.treat(c.subj, "recognition", 9, "you asked her if she wanted to go, and she stayed"); c.like("collector", -10);
            return { text: `"No," she says. Then, to ${c.n("collector")}: "No, thank you." ${c.n("collector")} is clearly annoyed with you.`, next: "theft", after: 5 }; } },
      ],
    },
    theft: {
      ...
      options: [
        ...
        { id: "guard", label: "Double the guard on her", note: "¤4,000", need: cash(4000),
          run: (c) => { c.cash(-4000); c.security(4); c.treat(c.subj, "kindness", 3, "you put guards on her door");
            return { text: `There's a guard on her door now. She complains about it, but she's glad of it.`, end: "you kept her from the collector" }; } },
        { id: "sell", label: "Sell her before they try again", note: (c) => `+${money(valuePerson(c.s, c.subj!) * 2)}`,
          run: (c) => { if (c.subj) c.remove(c.subj, "sold", `sold to ${c.full("collector")} after the attempt`, Math.round(valuePerson(c.s, c.subj) * 2)); c.hope(-6);
            return { text: `The collector knows you're worried now, so the price is lower. She goes anyway.`, end: "you sold her after the break-in" }; } },
      ],
    },
  },
};
      ...
      options: [
        { id: "meet", label: "Let them meet, for an hour",
          run: (c) => { c.treat(c.subj, "kindness", 8, "you let her sister in"); c.set("sis_met", true);
            return { text: `They're in the small lounge for an hour. You don't listen. When the door opens, ${c.sn} has been crying and ${c.n("sister")} is determined. She asks you, "How much?"`, next: "price", after: 0 }; } },
        { id: "away", label: "Send her away",
          run: (c) => { c.treat(c.subj, "cruelty", 4, "her sister was sent away from the gate"); if (c.subj && c.s.memory[c.subj.id]) c.set("sis_sent", true);
            return { text: `The guard walks her back to the bus stop. She goes without a fight, but she leaves the photograph with him. He brings it to you. ${c.sn} finds out soon after, and she's devastated.`, end: "you sent the sister away" }; } },
        { id: "take", label: "Take her too", need: secure(35),
          run: (c) => { const p = c.addSlave({ seed: "sister", name: `${c.full("sister")}`, age: Math.max(18, (c.subj?.age ?? 24) + 2), nation: c.subj?.origin.nationality, quality: 0.3, how: `came to the gate looking for her sister, and was taken`, hostile: true }); c.npc("sister").status = "owned"; c.npc("sister").person = p.id; c.crime(2); c.treat(c.subj, "cruelty", 6, "her sister was taken at the gate");
            ...
            return { text: `She's brought in out of the rain and doesn't understand what's happening until the collar's on. Then she does. They share a dormitory now, and both of them hate you.`, end: "you took the sister too" }; } },
      ],
    },
    price: {
      title: "\"How much?\"",
      ...
      options: [
        ...
        { id: "full", label: "Demand full price", note: "she can't pay it",
          run: (c) => { c.treat(c.subj, "cruelty", 5, "you wouldn't take what her sister had");
            return { text: `${c.n("sister")} goes white, then red. She leaves the money belt on the table — "a deposit," she says — and walks out. She promises she'll be back with the rest.`, next: "back", after: 8 }; } },
        { id: "stay", label: "Offer the sister a job in the building instead",
          run: (c) => { c.set("sis_citizen", true); c.treat(c.subj, "kindness", 6, "her sister lives in the building now"); c.prosperity(1);
            return { text: `She takes a job in the laundry and a room on the ninth floor. She visits every Sunday, and ${c.sn} is much happier for it.`, end: "the sister stayed as a citizen" }; } },
      ],
    },
    back: {
      ...
      options: [
        { id: "sell", label: "Sell her the freedom, on camera", run: (c) => { c.cash(22000); if (c.subj) c.remove(c.subj, "free", "bought free by her sister"); c.standing(1); c.hope(8);
          return { text: `You shake the sister's hand for the camera. You look generous on camera, and you're eleven thousand richer for it.`, end: "the sister bought her free, the second time" }; } },
        { id: "no", label: "Refuse, on camera", run: (c) => { c.rep(-300); c.standing(-2); c.treat(c.subj, "cruelty", 6, "you refused her sister twice");
          return { text: `It plays on every screen in the region by night. Everyone now knows you as the owner who wouldn't sell a slave back to her own sister.`, end: "you refused the sister twice" }; } },
      ],
    },
  },
};
      ...
      options: [
        { id: "buy", label: "Buy four of them cheap, as they are", note: "¤4,000; they may be sick", need: cash(4000),
          run: (c) => { c.cash(-4000);
            ...
            return { text: `They come up the gangway wrapped in blankets. Two of them can walk. You have four new slaves, and whatever they're sick with is now in your arcology.`, next: "spread", after: 2 }; } },
      ...
      options: [
        { id: "treat", label: "Buy curatives for everyone", note: "¤8,000", need: cash(8000),
          run: (c) => { c.cash(-8000); for (const p of c.owned()) { p.health.illness = 0; p.health.health = clamp(p.health.health + 10, -100, 100); } c.household("kindness", 2, "you paid to treat everyone");
            return { text: `It's expensive, but within two weeks nobody's coughing. Your slaves are grateful you treated all of them.`, end: "you treated the whole house" }; } },
        { id: "quarantine", label: "Lock the sick ones in the cellblock",
          run: (c) => { for (const p of c.owned().slice(0, 3)) { p.health.health = clamp(p.health.health - 15, -100, 100); p.health.illness = 0; } c.household("cruelty", 2, "the sick were locked in the cells");
            return { text: `It works, eventually. Two of them never fully recover, and the rest resent it.`, end: "you quarantined the sick in the cells" }; } },
      ],
    },
    doctor: {
      title: (c) => `${c.n("doctor")}`,
      ...
      options: [
        ...
        { id: "no", label: "\"I'll call you if I need you.\"",
          run: (c) => ({ text: `${c.n("doctor")} nods and leaves a card. It has just a phone number on it.`, end: "you let the doctor go" }) },
      ],
    },
  },
};
      ...
      options: [
        ...
        { id: "look", label: "Take it — and look in the crates", need: skill("hacking", 20),
          run: (c) => { c.cash(6000); c.set("fixer_in", true); c.set("fixer_knows", true);
            return { text: `Guns. Not many, and not new, but guns, with the serial numbers ground off and a delivery manifest for Ardent. Now you know what you're storing.`, next: "raid", after: 6 }; } },
      ...
      options: [
        ...
        { id: "sell", label: "Sell the guns to Ardent yourself", show: (c) => !!c.flag("fixer_knows"),
          run: (c) => { c.cash(25000); c.like("fixer", -80); c.npc("fixer").status = "gone";
            return { text: `Ardent pays well for the guns and better for the fixer's client list. ${c.n("fixer")} learns about it from a newspaper. You'd better watch your back for a while.`, end: "you sold the fixer's guns out from under them" }; } },
      ...
      options: [
        { id: "stairs", label: "Go after whoever's on the stairs",
          run: (c) => { c.set("bo_went", "stairs");
            return { text: `You take a torch and go down. On the fourteenth-floor landing you find ${c.sn}, barefoot, with a stolen keycard and a bag she packed weeks ago. She doesn't try to run.`, next: "caught", after: 0 }; } },
      ...
      options: [
        { id: "let", label: "Step aside",
          run: (c) => { if (c.subj) c.remove(c.subj, "gone", "you let her go in the blackout"); c.hope(10); c.rumor("the owner let one of them walk out in the blackout", 1);
            return { text: `She doesn't believe you at first. Then she runs down the stairs and you hear the fire door at the bottom bang open. You never see her again. Your slaves talk about it for months.`, end: "you let her go" }; } },
        { id: "back", label: "Take her back upstairs without a word",
          run: (c) => { c.treat(c.subj, "kindness", 3, "brought back without punishment");
            return { text: `You walk her back up fourteen floors in the dark. Neither of you says anything. She's at work the next morning as if nothing happened, and neither of you ever brings it up.`, end: "you brought her back and said nothing" }; } },
        { id: "punish", label: "Make an example of her",
          run: (c) => { if (c.subj) { resolveAct(c.s, c.subj, "discipline"); c.subj.assignment = "be confined in the cellblock"; } c.treat(c.subj, "cruelty", 8, "caught running in the blackout"); c.household("coercion", 4, "saw what happened to the one who ran");
            return { text: `She's in the cellblock by morning, and you have your other slaves walk past her cell on the way to breakfast.`, end: "you made an example of the one who ran" }; } },
      ],
    },
    gone: {
      ...
      options: [
        { id: "hunt", label: "Hunt her down", note: "¤5,000", need: cash(5000),
          run: (c) => { c.cash(-5000); if (c.subj) c.subj.assignment = "be confined in the cellblock"; c.treat(c.subj, "cruelty", 7, "hunted down and brought back"); c.hope(-10);
            return { text: `They find her in a flat in Kestrel four days later and bring her back in the boot of a car. All your slaves see her dragged back in.`, end: "you hunted her down" }; } },
...
${c.full("auctioneer")} calls personally. "Reserve is forty thousand. ${c.full("rival_owner")}'s bidding. I thought you'd want to know."`,
    ...
    bid: {
      title: "Lot one",
      text: (c) => `The room is full. She's brought out in a plain grey leotard and stands perfectly still on the auction block.
...
const flame: ArcDef = {
  ...
  beats: {
    arrive: {
      ...
      text: (c) => `${c.full("flame")}. You haven't seen ${c.him("flame")} in eleven years. ${c.He("flame")}'s standing in your lobby gawking at the atrium, with one small suitcase and a worn-out coat.
      ...
      options: [
        { id: "up", label: "Bring them up to the penthouse",
          run: (c) => { c.like("flame", 15);
            return { text: `${c.n("flame")} walks round the penthouse touching things. "I'm in trouble," ${c.he("flame")} finally says. "Money. The kind with men attached. I didn't know who else to come to."`, next: "trouble", after: 0 }; } },
      ...
      options: [
        { id: "pay", label: "Pay it", note: "¤30,000", need: cash(30000),
          run: (c) => { c.cash(-30000); c.like("flame", 40); c.npc("flame").status = "ally";
            return { text: `${c.n("flame")} cries, then asks if ${c.he("flame")} can stay a few days. ${c.He("flame")} stays three weeks, and leaves you a grateful letter.`, end: "you paid your old flame's debts" }; } },
        ...
        { id: "no", label: "Send them away", run: (c) => { c.like("flame", -30);
          return { text: `${c.He("flame")} picks up the suitcase and leaves. A month later you hear ${c.he("flame")} was found dead in the water near the Kestrel causeway.`, end: "you sent your old flame away" }; } },
      ],
    },
  },
};

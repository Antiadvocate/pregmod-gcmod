...
globalThis.PersonalAssistantAppearance = function() {
	...
	const masturbationAllowed = getSlaves().some((s) => s.rules.release.masturbation === 1) ? 1 : 0;
	...
	function FSfunc() {
		...
		const fsAppearance = {
			...
			"monstergirl": {
				...
				"antebellum revivalist": `${HeA} curiously inspects a pair of heavy deer antlers that have sprouted from ${hisA} head. It's hard to notice, but ${hisA} features are a little gaunter, almost skeletal, and ${hisA} eyes occasionally flash a sinister red.`,
			...
			"shemale": {
				...
				"antebellum revivalist": `${HeA}'s wearing a billowy white shirt, showing off ${hisA} chest, and tight trousers.`,
			...
			"slimegirl": {
				...
				"antebellum revivalist": `slime, a rustic straw hat with a feather floating inside ${himA}.`,
			...
			"angel": {
				...
				"antebellum revivalist": `${HeA} is wearing a wearing a nearly transparent white gown. Large, downy wings protrude from ${hisA} back, and a golden halo hovers perfectly in place above ${hisA} head.`,

App.Arcology.changeLanguage = function() {
	...
	const languageList = new Set(["English", "Spanish", "Arabic", "Chinese", "Japanese", V.temp.customLanguage, V.language]);
	...
	options.addOption("Select a custom language to be applied: ", "customLanguage", V.temp).showTextBox().addComment("A single capitalized word is recommended.");

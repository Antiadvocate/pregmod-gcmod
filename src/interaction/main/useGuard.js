...
App.Interact.guardPose = function(slave) {
	...
	switch (slave.clothes) {
		...
		case "a nipple bikini":
			r += `${His} nipple bikini's erotic appearance clashes amusingly with ${his} deadly weapons.`;
			break;
		...
		case "striped underwear":
			...
			break;
		case "slave rags":
			r += `${His} ragged appearance make ${him} look completely psychotic.`;
			break;
		case "a slutty magical girl costume":
			r += `${His} modern weapons clash with ${his} fantastical costume.`;
			break;
		// WIP
		case "a superhero outfit":
			r += `${His} leotard matches perfectly with ${his} deadly weaponry.`;
			break;
		case "a streetwear outfit":
		case "a leather outfit":
			r += `${His} outfit, paired with ${his} deadly weaponry, gives ${him} the look of a professional killer.`;
			break;
		case "a tribal outfit":
		case "a tropical outfit":
			r += `${His} outfit, paired with ${his} deadly weaponry, makes ${him} look the part of a sexy jungle warrior.`;
			break;
		case "a valkyrie outfit":
			r += `${His} outfit, paired with ${his} deadly weaponry, gives ${him} perfect valkyrie vibes.`;

		case "a coat and corset":
			r += `${His} lacy lingerie draws the attention away from ${his} deadly weaponry.`;
			break;
		case "a babydoll":
			r += `${His} lacy lingerie contrasts with ${his} deadly weaponry.`;
			break;
		...
		case "a samba outfit":
			r += `${His} bikini's flirty appearance clashes amusingly with ${his} deadly weapons.`;
			break;
		case "a cardigan":

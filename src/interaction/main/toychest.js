	...
	if (slave.fuckdoll) {
		...
		switch (slave.clothes) {
			...
			case "a nipple bikini":
				r += `${He}'s wearing a nipple bikini, making ${him} a lewd, enticing office ornament.`;
				break;
			...
			case "a monokini":
				...
				break;
			case "an apron":
				r += `${His} apron gives the office an intimate air, especially since ${he}'s nude underneath it.`;
				break;
			case "a cybersuit":
			...
			case "a Santa dress":
				...
				break;
			case "slave rags":
				r += `${His} old rags contrast the opulence of your office, making the difference between owner and slave abundantly clear.`;
				break;
			case "a slutty magical girl costume":
				r += `${His} costume speaks to the depths that a magical ${boy} can fall.`;
				break;
			// WIP
			case "a superhero outfit":
			case "a magical girl costume":
				r += `${His} outfit lends your office the air of a superhero command center.`;
				break;
			case "a streetwear outfit":
			case "a leather outfit":
				r += `The streetwear outfit ${he}'s wearing gives your office a very laid-back atmosphere.`;
				break;
			case "a country outfit":
			case "an eastern european outfit":
				r += `The outfit ${he}'s wearing gives your office a very traditional atmosphere.`;
				break;
			case "a samba outfit":
			case "a tribal outfit":
			case "a tropical outfit":
				r += `The outfit ${he}'s wearing gives your office a distinct tropical atmosphere.`;
				break;
			case "a valkyrie outfit":
				r += `The outfit ${he}'s wearing gives your office a distinct viking theme.`;
				break;
			case "a sundress":
			...
			case "an ice queen outfit":
				r += `The gorgeous dress ${he}'s wearing is almost a work of art.`;
				break;
			case "a coat and corset":
				r += `${He}'s wearing raunchy lingerie, covered by an imposing trench coat, making ${him} a sexy, enticing office ornament.`;
				break;
			case "a frilly bikini":
				r += `${He}'s wearing a frilly bikini, making ${him} a sexy, enticing office ornament.`;
				break;
			case "a babydoll":
				r += `${He}'s wearing classy lingerie, making ${him} an unusually refined ornament to the office.`;
				break;

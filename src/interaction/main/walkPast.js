...
globalThis.walkPast = (function() {
	...
	*/
			...
			case Job.HEADGIRLSUITE:
				...
				break;
			case Job.STEWARD:
				t += `is managing the house servants in ${App.Entity.facilities.servantsQuarters.name}: ${he} overseeing the laboring house slaves and punishing any that step out of line.`;
				break;
			case Job.TEACHER:
	...
	function boobWatch(slave) {
		...
		switch (slave.clothes) {
			...
			case "a nipple bikini":
				t += `${His} bikini covers only ${his} nipples, leaving the remainder of ${his} ${breasts} naked.`;
				if (slave.boobs >= 850 && slave.boobsImplant / slave.boobs < .50) {
					t += ` Since all of their weight is supported from the tip, they adopt an amusing, hammock-like shape that threatens to break free with each motion.`;
				}
				break;
			...
			case "slave rags":
				if (slave.boobs < 300) {
					t += `With no breasts to speak of, the rags actually provide ${him} some modesty.`;
				} else {
					t += `Rags offer little support or modesty, so nothing stops you from oggling ${his} breasts as ${he} moves.`;
				}
				break;
			case "a slutty magical girl costume":
				if (slave.boobs < 300) {
					t += `${His} bodysuit draws the eye straight to ${his} obvious nipples, since it lacks anything else to show off.`;
				} else {
					t += `${His} bodysuit is tight enough that it not only hugs ${his} breasts, but shows off ${his} nipples as well.`;
				}
				break;
			...
			case "a turtleneck and miniskirt":
				t += `${His} outfit leaves a lot to the imagination.`;
				break;
			// ends WIP block
	...
	function buttWatch(slave) {
		...
		switch (slave.clothes) {
			...
			case "a string bikini":
				...
				break;
			case "a nipple bikini":
				t += `As ${he} moves, ${his} lingerie leaves almost the entire line of ${his} hips naked and enticing.`;
				break;
			case "a scalemail bikini":
			...
			case "a courtesan dress":
				...
				break;
			case "slave rags":
				t += `${His} rags are just begging to be torn off.`;
				break;
			case "a slutty magical girl costume":
				if (slave.butt > 5) {
					t += `${His} bodysuit has magically vanished in the depths of ${his} asscrack.`;
				} else if (slave.butt > 2) {
					t += `${His} bodysuit hugs the contours of ${his} inner butt.`;
				} else {
					t += `${His} bodysuit hugs the contours of ${his} butt.`;
				}
				break;
			// WIP
			case "a superhero outfit":
				...
				if (slave.belly >= 600000) {
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} enormous belly lewdly stretches ${his} narrow bodysuit, spilling out from its sides.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} giant belly lewdly stretches ${his} narrow bodysuit, spilling out from its sides.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit bulges with ${his} massive gut, with most of it spilling out from the sides.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit can barely contain ${his} huge belly; it's clear something has had its way with this magical ${boy}.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit bulges with ${his} giant gut, with a hefty amount of it spilling out from the sides.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit bulges around ${his} big gut as some of it spills out from its sides.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit swells with ${his} big belly; it's clear something has had its way with this magical ${boy}.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit just barely manages to contain ${his} gut.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit tightly hugs ${his} growing belly; did something have its way with this magical ${boy}?`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
				...
				if (slave.bellyImplant >= 32000) {
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit lewdly hugs ${his} enormous belly.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit lewdly hugs ${his} giant belly.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit lewdly hugs ${his} huge belly.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit lewdly hugs ${his} big belly.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
					...
					switch (slave.clothes) {
						...
						case "a courtesan dress":
							...
							break;
						case "a slutty magical girl costume":
							t += `${His} narrow bodysuit bulges with ${his} distended belly.`;
							break;
						// WIP
						case "a superhero outfit":
						case "a streetwear outfit":
			...
			if (slave.weight > 190) {
				...
				switch (slave.clothes) {
					...
					case "a courtesan dress":
						...
						break;
					case "a slutty magical girl costume":
						t += `${His} narrow bodysuit can barely contain ${his} taut, sloshing belly; it's clear something has had its way with this magical ${boy}.`;
						break;
					// WIP
					case "a superhero outfit":
					case "a streetwear outfit":
				...
				switch (slave.clothes) {
					...
					case "a courtesan dress":
						...
						break;
					case "a slutty magical girl costume":
						t += `${His} narrow bodysuit swells with ${his} rounded, sloshing belly; it's clear something has had its way with this magical ${boy}.`;
						break;
					// WIP
					case "a superhero outfit":
					case "a streetwear outfit":
				...
				switch (slave.clothes) {
					...
					case "a courtesan dress":
						...
						break;
					case "a slutty magical girl costume":
						t += `${His} narrow bodysuit tightly hugs ${his} distended belly; did something have its way with this magical ${boy}?`;
						break;
					// WIP
					case "a superhero outfit":
					case "a streetwear outfit":
	...
	function vaginaWatch(slave) {
		...
		switch (slave.clothes) {
			...
			case "a nipple bikini":
				if (slave.dick > 4) {
					t += `As ${he} moves, ${his} bikini bottom totally fails to restrain ${his} huge penis.`;
				} else if (slave.dick !== 0) {
					t += `As ${he} moves, your eye is drawn to the bulge in ${his} bikini bottom.`;
				} else if (slave.vagina !== 0) {
					t += `As ${he} moves, ${his} bikini bottom nicely hugs ${his} pussylips.`;
				} else {
					t += `As ${he} moves, ${his} bikini bottom smoothly covers ${his} featureless crotch.`;
				}
				break;
			case "a scalemail bikini":
				if ((slave.dick > 4) && (slave.vagina !== -1)) {
			...
			case "slave rags":
				if ((slave.dick > 0) && canAchieveErection(slave)) {
					t += `${His} rags can't hide ${his} erection and has slid to its side.`;
				} else if (slave.dick > 5) {
					t += `${His} rags are too short to cover ${his} penis, drawing the eye straight to it.`;
				} else {
					t += `${His} rags often slip aside, flashing a glimpse of ${his} `;
					if ((slave.dick !== 0) && (slave.vagina !== -1)) {
						t += `hermaphroditic genitalia.`;
					} else if (slave.dick !== 0) {
						t += `penis.`;
					} else if (slave.vagina !== -1) {
						t += `pussy.`;
					} else {
						t += `featureless crotch.`;
					}
				}
				break;
			case "a slutty magical girl costume":
				t += `Beneath ${his} skirt, ${his} bodysuit tightly hugs ${his} `;
				if ((slave.dick !== 0) && (slave.vagina !== -1)) {
					t += `hermaphroditic genitalia, showcasing every little detail.`;
				} else if (slave.dick !== 0) {
					t += `penis, showcasing every little detail.`;
				} else if (slave.vagina !== -1) {
					t += `pussy, showcasing every little detail.`;
				} else {
					t += `featureless crotch.`;
				}
				break;
		...
		if (slave.chastityAnus === 0) {
			...
			switch (slave.clothes) {
				...
				case "a string bikini":
					...
					break;
				case "a nipple bikini":
					t += `${His} bikini bottom conceals his butthole, but can be slipped aside easily enough.`;
					break;
				case "a scalemail bikini":
				...
				case "a courtesan dress":
					...
					break;
				case "slave rags":
					t += `${His} rags are just begging to be torn off to reveal ${his} butthole.`;
					break;
				case "a slutty magical girl costume":
					t += `You can see every detail of ${his} butthole through ${his} bodysuit.`;
					break;
				// WIP
				case "a superhero outfit":
				case "a streetwear outfit":

...
App.EndWeek.clinicReport = function() {
	...
	if (restedSlaves > 0) {
		...
		if (V.clinicDecoration !== "standard") {
			App.Events.addNode(afterFrag, [`${capFirstChar(V.clinicName)}'s ${V.clinicDecoration} atmosphere <span class="hotpink">had an impact on them while they were getting treatment.</span>`], "p", ["indent"]);
		}
	}

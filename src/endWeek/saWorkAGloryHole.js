...
App.SlaveAssignment.workAGloryHole = function saWorkAGloryHole(slave) {
	...
	function physicalEffects(slave) {
		...
		if (slave.vagina === 0 && canDoVaginal(slave)) {
			...
			slave.trust -= 10;
			slave.vagina = 1;
		} else if (V.seeStretching === 1 && slave.vagina < 3 && canDoVaginal(slave) && jsRandom(1, 100) > ((220 - vaginalUse) + (slave.vagina * 10))) {
		...
		if (slave.anus === 0 && canDoAnal(slave)) {
			...
			slave.trust -= 5;
			slave.anus = 1;
		} else if (V.seeStretching === 1 && slave.anus < 3 && canDoAnal(slave) && jsRandom(1, 100) > ((200 - analUse) + (slave.anus * 10))) {

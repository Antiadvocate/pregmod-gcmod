App.Art.GenAI.Ill.TailPromptPart = class TailPromptPart extends App.Art.GenAI.PromptPart {
	/**
	 * @override
	 */
	positive() {
		...
		if (this.slave.tail && this.slave.tail !== "none") {
			parts.push("tail");
		}
		...
		if (this.slave.tail === "mod" && this.slave.tailShape && this.slave.tailShape !== "none") {

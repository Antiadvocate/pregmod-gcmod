...
new App.DomPassage("Slave Interact",
	() => {
		...
		return App.UI.SlaveInteract.mainPage(V.temp?.AS);
	}, ["jump-from-safe"]
);
...
new App.DomPassage("SlaveOnSlaveFeeding",
	() => {
		...
		return App.UI.SlaveInteract.slaveOnSlaveFeedingSelection(getSlave(V.temp.AS));
	}
);

new App.DomPassage("KillSlave", () => App.UI.SlaveInteract.killSlave(getSlave(V.temp.AS)));
...
new App.DomPassage(
	...
	() => {
		...
		V.nextLink = "Main";
		return bodySwapSelection(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = "Abort Operation";
		if (!V.temp.husk) {
			throw new Error(`V.temp.husk is not set`);
		}
		if (V.temp.husk.tankBaby !== 3) {
		...
		return huskSwapSelection(V.temp.husk);
	}
);
...
new App.DomPassage(
	...
	() => {
		...
		return App.UI.SlaveInteract.agentCompany(getSlave(V.temp.AS));
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		...
		return App.UI.SlaveInteract.surgeryDegradation(getSlave(V.temp.AS));
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = "Confirm changes";
		V.nextLink = "Slave Interact";
		return App.UI.SlaveInteract.remoteSurgery(getSlave(V.temp.AS));
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = "Continue";
		V.nextLink = "Slave Interact";
		return App.UI.SlaveInteract.importSlaveFromJson();
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = "Continue";
		V.nextLink = "Slave Interact";
		return App.UI.SlaveInteract.importSlaveFromCharacterCard();
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = "Continue";
		V.nextLink = "Slave Interact";
		return App.UI.SlaveInteract.exportSlaveDocument(getSlave(V.temp.AS));
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		...
		el.appendChild(App.UI.SlaveInteract.SlaveBot.createSlaveBot(getSlave(V.temp.AS)));
		return el;
	}, ["jump-from-safe"]
);
...
new App.DomPassage(
	...
	() => {
		V.nextButton = " ";
		return App.UI.SlaveInteract.cheatEditSlave(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("BreedingTest",
	() => {
		V.nextButton = "Confirm changes";
		V.nextLink = "Slave Interact";
		return App.UI.DOM.makeElement("div", App.Interact.eliteBreedingExam(getSlave(V.temp.AS)));
	}
);
...
new App.DomPassage("Aztec Slave Sacrifice Penance",
	() => {
		...
		return App.UI.SlaveInteract.aztecSlaveSacrificePenance(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Aztec Slave Sacrifice Life",
	() => {
		...
		V.nextLink = "Main";
		App.UI.StoryCaption.encyclopedia = "Aztec Revivalism";
		return App.UI.SlaveInteract.aztecSlaveSacrificeLife(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Abort",
	() => {
		V.nextButton = "Back";
		V.nextLink = "Slave Interact";
		return App.Interact.abort(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("FAnimalImpreg",
	() => {
		V.nextButton = "Back";
		V.nextLink = "Slave Interact";
		return App.Interact.fAnimalImpreg(getSlave(V.temp.AS));
	}
);

new App.DomPassage("Matchmaking",
	() => {
		if (lastPassage() === "Child Interact") {
			V.nextLink = "Incubator";
		} else {
			V.nextLink = "Slave Interact";
		}
		V.nextButton = "Continue";
		return App.Interact.matchmaking(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("FMarry",
	() => {
		V.nextButton = "Back";
		V.nextLink = "Slave Interact";
		return App.Interact.fMarry(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Discard Confirm",
	() => {
		V.nextButton = "Back";
		V.nextLink = "Slave Interact";
		return App.Interact.discard(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Sell Slave",
	() => {
		V.nextButton = "Back";
		V.nextLink = "Slave Interact";
		return App.Interact.sellSlave(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Brothel Assignment Scene",
	() => {
		...
		return App.Facilities.Brothel.assignmentScene(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Industrial Dairy Assignment Scene",
	() => {
		...
		return App.Facilities.Dairy.industrialAssignmentScene(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Free Range Dairy Assignment Scene",
	() => {
		App.UI.StoryCaption.encyclopedia = "Dairy";
		return App.Facilities.Dairy.freeRangeAssignmentScene(getSlave(V.temp.AS));
	}
);
...
new App.DomPassage("Prosthetics Configuration",
	() => {
		const slave = getSlave(V.temp.AS);

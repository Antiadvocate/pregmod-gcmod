...
/**
 * @deprecated use App.UI.DOM.link() instead
 * TODO: @franklygeorge this is only used in FCTVshows.js. Replace the usage there and then remove this function
 * @see App.UI.DOM.link
 */
...
App.UI.DOM.slaveDescriptionDialog = function(
	...
	const link = App.UI.DOM.link(text ? text: SlaveFullName(slave), () => {
		Dialog.create(SlaveFullName(slave));

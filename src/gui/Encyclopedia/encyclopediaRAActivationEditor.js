App.Encyclopedia.addArticle("RA Condition Editor", function() {
	...
	acc.toParagraph();
	acc.push(
		"Documentation for slave attributes can be found",
		...
		"Alternatively you can look up the properties needed in one of the following files:",
		"<a target='_blank' class='link-external' href='https://gitgud.io/pregmodfan/fc-pregmod/-/blob/pregmod-master/src/js/states/001-GenePoolRecord.js'>001-GenePoolRecord.js (most physical attributes)</a>,",
		"<a target='_blank' class='link-external' href='https://gitgud.io/pregmodfan/fc-pregmod/-/blob/pregmod-master/src/js/states/002-HumanState.js'>002-HumanState.js (anything not in 001-GenePoolRecord.js that is shared with the player character)</a>, or",
		"<a target='_blank' class='link-external' href='https://gitgud.io/pregmodfan/fc-pregmod/-/blob/pregmod-master/src/js/states/003-SlaveState.js'>003-SlaveState.js (everything not in 001-GenePoolRecord.js or 002-HumanState.js)</a>",
	);
	acc.toParagraph();

...
App.Encyclopedia.addArticle("Antebellum Revivalism", function() {
	const t = new DocumentFragment();
	App.Events.addNode(t, [App.UI.DOM.makeElement("span", "Antebellum Revivalism", ["bold"]),
		"is a future society model nostalgic for the pre-civil war American south, a quasi-feudal society built on chattel slavery.",
		"Modern enthusiasts see parallels in the economics of most arcologies and the Antebellum era, and believe the landowning aristocracy of it's day a natural fit for modern society.",
		"Antebellum revivalism approves of maintaining personal honor and integrity, keeping a large stable of slaves and servants, and having skill at breaking slaves."], "div", ["indent"]);
	App.Events.addNode(t, ["Increases prosperity and attractiveness for the upper echelons of society and somewhat for the middle class."], "div", ["indent"]);
	App.Events.addNode(t, ["Lowers prosperity and attractiveness for the lower classes."], "div", ["indent"]);
	App.Events.addNode(t, ["Dramatically increases slave demand for the upper and top classes."], "div", ["indent"]);
	App.Events.addNode(t, ["Speeds up increases in the ratio of slaves to citizens."], "div", ["indent"]);

...
App.Intro.alphaDisclaimer = function() {
	...
	App.Events.addNode(p, [
		...
		`That means the game is missing content, is full of bugs, is imbalanced, and is generally in an incomplete state. The game will keep a start of turn autosave. If you encounter a bug, we strongly recommend you reload your start of turn autosave immediately. Please submit your feedback and bug reports <a class="link-external" href='https://gitgud.io/pregmodfan/fc-pregmod/issues/' target='_blank'>here</a>. Consider attaching a save file and screenshot of the problem.`,
	], "div");
	App.Events.addNode(p, [`Pregmod is a modification of the original <i>Free Cities</i> ${V.ver} created by FCdev, which can be seen <a class="link-external" href='https://freecitiesblog.blogspot.com/' target='_blank'>here</a>.`], "div");

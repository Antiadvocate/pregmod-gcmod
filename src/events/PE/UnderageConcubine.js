	...
	execute(node) {
		...
		function interview() {
			...
			App.Events.addResponses(frag, [
				...
				puberty ? new App.Events.Result(`Sex with teens is common, as it has been historically`, ephebophile) : new App.Events.Result(),

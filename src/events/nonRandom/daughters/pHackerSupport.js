...
App.Events.PHackerSupport = class PHackerSupport extends App.Events.BaseEvent {
	execute(node) {
		...
		r = [];
		r.push(`"Hi!" she says cheerfully. "I seen you been contacted by these Daughters cunts. They been after me too. They're pretty decent at cyber-warfare, but I'm fuckin' better." A momentary discomfort crosses her face, and she shifts a little in her seat. "They're building up for somethin' big. Wouldn't a' contacted you at all, let us both fight our own fights, but I gotta short fuse on this vulnerability and I need to bribe a weak link. Your money can get me in; my skills can fuck 'em up. What do you say?${(traitor.actor && traitor.type === "hostage") ? `If it sweetens the deal at all, I can even get ${traitor.actor.slaveName} out of hot water. Not the brightest, that one.` : ""}"`);

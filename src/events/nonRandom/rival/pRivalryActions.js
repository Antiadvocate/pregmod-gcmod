...
App.Events.pRivalryActions = function() {
	...
	function execute() {
		...
		const {woman2, he2, his2, him2, mother2, wife2} = getPronouns(hostageWife || {pronoun: 0}).appendSuffix("2");
		...
		if (V.rival.hostageState === 1 && hostageActor) {
			...
			if (V.rival.duration >= 30) {
				...
				r.push(`The latest message from your rival recently arrived, showing ${SlaveFullName(hostageActor)}`);
			}
			if (V.rival.duration === 1) {
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 10;
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.behavioralFlaw = "arrogant";
						hostageActor.sexualFlaw = "shamefast";
						r.push(`bound and offered to a pair of ${V.arcologies[0].FSSubjugationistRace} girls.`);
						break;
					case "Racial Supremacism":
						hostageActor.trust += 5;
						hostageActor.devotion += 5;
						hostageActor.counter.oral += 50;
						hostageActor.counter.vaginal += 50;
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						hostageActor.behavioralFlaw = "odd";
						hostageActor.sexualFlaw = "repressed";
						r.push(`being registered as a piece of ${V.arcologies[0].FSSupremacistRace} meat, fit only to be abused.`);
						break;
					case "Repopulation Focus":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 5;
						hostageActor.counter.vaginal += 5;
						hostageActor.counter.anal += 5;
						hostageActor.counter.mammary += 5;
						hostageActor.behavioralQuirk = "adores men";
						hostageActor.sexualQuirk = "caring";
					...
					case "Eugenics":
						if (V.seeHyperPreg !== 1) {
							...
							hostageActor.devotion -= 5;
							hostageActor.preg = 4;
							hostageActor.pregType = 8;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = V.rival.duration;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
							SetBellySize(hostageActor);
							hostageActor.vagina = 2;
							hostageActor.counter.oral += 50;
							hostageActor.counter.vaginal += 50;
							hostageActor.counter.anal += 50;
							hostageActor.counter.mammary += 50;
							hostageActor.behavioralFlaw = "odd";
							hostageActor.sexualFlaw = "hates penetration";
							r.push(`undergoing a fertility screening; the video ends with the positive results.`);
						} else {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.preg = 4;
							hostageActor.pregType = 40;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = V.rival.duration;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
							SetBellySize(hostageActor);
					...
					case "Gender Radicalism":
						...
						hostageActor.devotion -= 5;
						hostageActor.behavioralFlaw = "arrogant";
						hostageActor.sexualFlaw = "idealistic";
						hostageActor.fetish = "none";
					...
					case "Gender Fundamentalism":
						...
						hostageActor.devotion -= 5;
						hostageActor.counter.anal += 10;
						hostageActor.behavioralFlaw = "hates men";
						hostageActor.sexualFlaw = "hates anal";
					...
					case "Paternalism":
						...
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						hostageActor.piercing.ear.weight = 1;
						hostageActor.piercing.nose.weight = 1;
						hostageActor.piercing.nipple.weight = 0;
						hostageActor.piercing.lips.weight = 0;
						hostageActor.piercing.vagina.weight = 0;
						hostageActor.piercing.anus.weight = 0;
						hostageActor.piercing.genitals.weight = 0;
						hostageActor.piercing.genitals.smart = false;
						hostageActor.piercing.eyebrow.weight = 0;
						hostageActor.piercing.navel.weight = 0;
						hostageActor.piercing.corset.weight = 0;
						hostageActor.piercing.areola.weight = 0;
						hostageActor.piercing.tongue.weight = 0;
						hostageActor.boobsTat = 0;
						hostageActor.buttTat = 0;
						hostageActor.vaginaTat = 0;
						hostageActor.lipsTat = 0;
						hostageActor.anusTat = 0;
						hostageActor.shouldersTat = 0;
						hostageActor.backTat = 0;
						hostageActor.armsTat = 0;
						hostageActor.legsTat = 0;
						hostageActor.stampTat = "degradation";
						hostageActor.behavioralFlaw = "odd";
						hostageActor.sexualFlaw = "apathetic";
						r.push(`crying as ${his} nose and ears are pierced and the first of many tattoos inked into ${his} flesh.`);
						break;
					case "Degradationism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.behavioralFlaw = "liberated";
						hostageActor.sexualFlaw = "idealistic";
					...
					case "Body Purism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.boobs += 2000;
						hostageActor.boobsImplant += 2000;
						hostageActor.boobsImplantType = "advanced fillable";
						hostageActor.behavioralFlaw = "anorexic";
						hostageActor.sexualFlaw = "shamefast";
					...
					case "Youth Preferentialism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 1;
						hostageActor.counter.vaginal += 1;
						hostageActor.counter.anal += 1;
						hostageActor.behavioralFlaw = "bitchy";
						hostageActor.sexualFlaw = "idealistic";
					...
					case "Slimness Enthusiasm":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.boobs += 1500;
						hostageActor.butt = 4;
						hostageActor.behavioralFlaw = "anorexic";
						hostageActor.sexualFlaw = "crude";
					...
					// 	hostage.lactation = 2;
					// 	hostage.lactationDuration = 2;
					// 	hostage.trust -= 5;
					// 	hostage.devotion -= 5;
					// 	hostage.boobs += 1000;
					// 	hostage.weight = 0;
					// 	hostage.butt = 4;
					// 	hostage.behavioralFlaw = "anorexic";
					// 	hostage.sexualFlaw = "shamefast";
					// 	r.push(`standing in front of a mirror sobbing as droplets of milk form on ${his} ${hostage.nipples} nipples, courtesy of ${his} newly implanted lactation drugs.`);
					// 	break;
					case "Pastoralism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.muscles = 0;
						hostageActor.behavioralFlaw = "gluttonous";
						hostageActor.sexualFlaw = "shamefast";
					...
					case "Physical Idealism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.boobs = 400;
						hostageActor.weight = 10;
						hostageActor.counter.vaginal += 28;
						hostageActor.vagina = 2;
						hostageActor.butt = 2;
						hostageActor.behavioralFlaw = "anorexic";
						hostageActor.sexualFlaw = "hates penetration";
					...
					case "Multiculturalism":
						...
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.counter.mammary += 10;
						hostageActor.behavioralFlaw = "liberated";
						hostageActor.sexualFlaw = "repressed";
					...
					case "Slave Professionalism":
						...
						hostageActor.devotion += 5;
						hostageActor.counter.vaginal += 10;
						hostageActor.energy += 5;
						hostageActor.addict += 2;
						hostageActor.hLength += 7;
						hostageActor.behavioralFlaw = "arrogant";
						hostageActor.sexualFlaw = "repressed";
					...
					case "Statuesque Glorification":
						...
						hostageActor.counter.anal += 1;
						hostageActor.behavioralFlaw = "liberated";
						hostageActor.sexualFlaw = "judgemental";
				...
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						...
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.fetish = "submissive";
						hostageActor.fetishStrength = 10;
						r.push(`no longer trying to escape from the ${V.arcologies[0].FSSubjugationistRace} girls.`);
						break;
					case "Racial Supremacism":
						hostageActor.trust += 5;
						hostageActor.devotion += 5;
						if (hostageActor.vagina < 2) {
							hostageActor.vagina = 2;
						}
						if (hostageActor.anus < 2) {
							hostageActor.anus = 2;
						}
						hostageActor.counter.oral += 50;
						hostageActor.counter.vaginal += 50;
					...
					case "Paternalism":
						...
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						hostageActor.heels = 1;
						hostageActor.piercing.ear.weight = 1;
						hostageActor.piercing.nose.weight = 1;
						hostageActor.piercing.nipple.weight = 1;
						hostageActor.piercing.lips.weight = 1;
						hostageActor.piercing.vagina.weight = 0;
						hostageActor.piercing.anus.weight = 0;
						hostageActor.piercing.genitals.weight = 1;
						hostageActor.piercing.eyebrow.weight = 0;
						hostageActor.piercing.navel.weight = 1;
						hostageActor.piercing.corset.weight = 0;
						hostageActor.piercing.areola.weight = 0;
						hostageActor.piercing.tongue.weight = 1;
						hostageActor.boobsTat = "degradation";
						hostageActor.backTat = "degradation";
						hostageActor.stampTat = "degradation";
						hostageActor.fetish = "masochist";
						hostageActor.fetishStrength = 10;
						App.Medicine.Modification.addScar(hostageActor, "left ankle", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "right ankle", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "left calf", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "right calf", "surgical", 2);
					...
					case "Body Purism":
						...
						hostageActor.boobs += 2000;
						hostageActor.boobsImplant += 2000;
						if (hostageActor.boobsImplant > 10000) {
							hostageActor.boobsImplantType = "hyper fillable";
						}
						hostageActor.boobShape = "spherical";
						hostageActor.nipples = "flat";
						hostageActor.fetish = "boobs";
						hostageActor.fetishStrength = 10;
						r.push(`blushing as ${he} attempts to get dressed with ${his} massive ${hostageActor.boobs}cc fake tits getting in the way.`);
						break;
					case "Transformation Fetishism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
					...
					case "Slimness Enthusiasm":
						...
						hostageActor.fetish = "boobs";
						hostageActor.fetishStrength = 10;
						r.push(`blushing as ${he} attempts to get dressed with ${his} massive ${hostageActor.boobs}cc tits getting in the way.`);
						break;
					case "Asset Expansionism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
					...
					case "Pastoralism":
						...
						hostageActor.muscles = 25;
						hostageActor.boobs = 1000;
						hostageActor.counter.vaginal += 1;
						hostageActor.fetish = "dom";
						hostageActor.fetishStrength = 10;
					...
					case "Cummunism":
						...
						hostageActor.fetish = "boobs";
						hostageActor.fetishStrength = 10;
						r.push(`groaning as ${he} lowers ${his} growing body onto ${his} cot. ${He} shoves a massive ${hostageActor.boobs}cc milky breast aside so ${he} can massage ${his} hugely distended belly. ${He} moans in pain under the massive amount of high-caloric fluid within ${his} gut.`);
						break;
					case "Physical Idealism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.weight = 50;
						hostageActor.boobs = 800;
						hostageActor.butt = 4;
						hostageActor.counter.vaginal += 28;
						hostageActor.vagina = 3;
						hostageActor.behavioralFlaw = "anorexic";
						hostageActor.sexualFlaw = "hates penetration";
						...
						if (V.seePreg !== 0) {
							hostageActor.fetish = either("boobs", "buttslut", "cumslut", "dom", "humiliation", "masochist", "pregnancy", "sadist", "submissive");
						} else {
							hostageActor.fetish = either("boobs", "buttslut", "cumslut", "dom", "humiliation", "masochist", "sadist", "submissive");
						}
						hostageActor.fetishStrength = 10;
						switch (hostageActor.fetish) {
							case "submissive":
								r.push(Spoken(hostageActor, `"I like getting dominated..."`));
								break;
							case "cumslut":
								r.push(Spoken(hostageActor, `"I like getting cummed on..."`));
								break;
							case "humiliation":
								r.push(Spoken(hostageActor, `"I like being humiliated..."`));
								break;
							case "buttslut":
								r.push(Spoken(hostageActor, `"I like getting assfucked..."`));
								break;
							case "boobs":
								r.push(Spoken(hostageActor, `"I like big breasts..."`));
								break;
							case "sadist":
								r.push(Spoken(hostageActor, `"I like hurting people..."`));
								break;
							case "masochist":
								r.push(Spoken(hostageActor, `"I like getting beaten..."`));
								break;
							case "dom":
								r.push(Spoken(hostageActor, `"I like getting my way..."`));
								break;
							case "pregnancy":
								r.push(Spoken(hostageActor, `"I want to get pregnant..."`));
								break;
						}
						...
						switch (hostageActor.fetish) {
							...
							case "boobs":
								...
								hostageActor.boobs += 1000;
								hostageActor.boobsImplant += 1000;
								hostageActor.boobsImplantType = "fillable";
								break;
							case "sadist":
							...
							case "pregnancy":
								...
								WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, 1);
								hostageActor.pregKnown = 1;
								hostageActor.pregWeek = 1;
								SetBellySize(hostageActor);
								break;
						}
						break;
					...
					case "Intellectual Dependency":
						...
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.intelligenceImplant = Math.clamp(hostageActor.intelligenceImplant + 1, 0, 30);
						hostageActor.skill.oral = Math.clamp(hostageActor.skill.oral + 5, 0, 100);
						hostageActor.skill.entertainment = Math.clamp(hostageActor.skill.entertainment + 5, 0, 100);
						hostageActor.skill.anal = Math.clamp(hostageActor.skill.anal + 5, 0, 100);
						hostageActor.skill.vaginal = Math.clamp(hostageActor.skill.vaginal + 5, 0, 100);
						hostageActor.skill.whoring = Math.clamp(hostageActor.skill.whoring + 5, 0, 100);
						hostageActor.fetish = "submissive";
						hostageActor.fetishStrength = 10;
					...
					case "Slave Professionalism":
						hostageActor.trust += 5;
						hostageActor.devotion += 5;
						hostageActor.intelligenceImplant = Math.clamp(hostageActor.intelligenceImplant - 5, 0, 30);
						hostageActor.counter.oral += 30;
						hostageActor.counter.vaginal += 30;
						hostageActor.counter.anal += 30;
						hostageActor.vagina = 3;
						hostageActor.anus = 3;
						hostageActor.energy += 5;
						hostageActor.addict += 2;
						hostageActor.hLength += 7;
						hostageActor.fetish = "humiliation";
						hostageActor.fetishStrength = 10;
						r.push(`uncontrollably masturbating as ${he} struggles to stay coherent.`);
						r.push(Spoken(hostageActor, `"I need it... I can't stop... Need more..."`));
					...
					case "Statuesque Glorification":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 3;
						hostageActor.counter.vaginal += 7;
						hostageActor.counter.anal += 7;
						hostageActor.fetish = "dom";
						hostageActor.fetishStrength = 10;
				...
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 20;
						hostageActor.counter.vaginal += 20;
						hostageActor.counter.anal += 20;
						hostageActor.fetishStrength = 65;
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "confident";
						hostageActor.sexualQuirk = "perverted";
						r.push(`calling ${his} ${V.arcologies[0].FSSubjugationistRace} girls for some release.`);
						break;
					case "Racial Supremacism":
						hostageActor.trust += 5;
						hostageActor.devotion += 5;
						if (hostageActor.preg < 1 && V.seePreg !== 0) {
							hostageActor.preg = 12;
							hostageActor.pregType = 1;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = 12;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
							SetBellySize(hostageActor);
						}
						if (hostageActor.vagina < 3) {
							hostageActor.vagina = 3;
						}
						if (hostageActor.anus < 3) {
							hostageActor.anus = 3;
						}
						hostageActor.counter.oral += 50;
						hostageActor.counter.vaginal += 50;
						...
						hostageActor.counter.mammary += 50;
						hostageActor.fetishStrength = 65;
						hostageActor.behavioralQuirk = "none";
						hostageActor.behavioralFlaw = "odd";
						hostageActor.sexualFlaw = "apathetic";
						App.Medicine.Modification.addScourged(hostageActor);
						App.Medicine.Modification.addScar(hostageActor, "anus", "generic");
						App.Medicine.Modification.addScar(hostageActor, "vagina", "generic");
					...
					case "Eugenics":
						if (V.seeHyperPreg !== 1) {
							...
							hostageActor.vagina = 3;
							hostageActor.boobs += 100;
							hostageActor.lactation = 1;
							hostageActor.lactationDuration = 2;
							hostageActor.counter.oral += 100;
							hostageActor.counter.vaginal += 100;
							hostageActor.counter.anal += 100;
							hostageActor.counter.mammary += 100;
							hostageActor.vaginaTat = "lewd crest";
							hostageActor.behavioralFlaw = "none";
							hostageActor.sexualFlaw = "none";
							hostageActor.behavioralQuirk = "adores men";
							hostageActor.sexualQuirk = "caring";
					...
					case "Gender Radicalism":
						...
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "insecure";
						hostageActor.sexualQuirk = "romantic";
						r.push(`realizing that a ${hostageActor.actualAge < 16 ? `${girl}` : `${woman}`}'s place is next to the powerful, not being powerful.`);
						break;
					case "Gender Fundamentalism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						...
						if (V.seeDicks !== 0) {
							hostageActor.dick = 1;
							hostageActor.skill.penetrative = Math.clamp(hostageActor.skill.penetrative + 5, 0, 100);
							hostageActor.counter.penetrative += 10;
						}
						hostageActor.vaginaTat = "lewd crest";
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "adores men";
						hostageActor.sexualQuirk = "size queen";
						hostageActor.fetishStrength = 65;
					...
					case "Paternalism":
						...
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						hostageActor.voice = 0;
						hostageActor.piercing.ear.weight = 2;
						hostageActor.piercing.nose.weight = 2;
						hostageActor.piercing.nipple.weight = 1;
						hostageActor.piercing.lips.weight = 1;
						hostageActor.piercing.vagina.weight = 1;
						hostageActor.piercing.anus.weight = 0;
						hostageActor.piercing.genitals.weight = 1;
						hostageActor.piercing.eyebrow.weight = 1;
						hostageActor.piercing.navel.weight = 2;
						hostageActor.piercing.corset.weight = 0;
						hostageActor.piercing.areola.weight = 1;
						hostageActor.piercing.tongue.weight = 1;
						hostageActor.buttTat = "degradation";
						hostageActor.vaginaTat = "degradation";
						hostageActor.shouldersTat = "degradation";
						hostageActor.armsTat = "degradation";
						hostageActor.legsTat = "degradation";
						App.Medicine.Modification.addScar(hostageActor, "anus", "generic");
						App.Medicine.Modification.addScar(hostageActor, "vagina", "generic");
						hostageActor.fetishStrength = 65;
						App.Medicine.Modification.addScar(hostageActor, "neck", "surgical", 2);
					...
					case "Degradationism":
						...
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "advocate";
						hostageActor.sexualQuirk = "romantic";
						hostageActor.fetishStrength = 65;
					...
					case "Body Purism":
						...
						hostageActor.butt = 7;
						hostageActor.buttImplant = 4;
						hostageActor.buttImplantType = "fillable";
						hostageActor.behavioralFlaw = "none";
						hostageActor.behavioralQuirk = "insecure";
						hostageActor.sexualFlaw = "crude";
						hostageActor.fetishStrength = 65;
						r.push(`getting off the surgical table and immediately falling to the floor under the weight of ${his} immense ${hostageActor.boobs}cc implants. ${He} quickly calls out, not for help, but for a dick in ${him} to celebrate this occasion.`);
						break;
					case "Transformation Fetishism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						...
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "fitness";
						hostageActor.sexualQuirk = "romantic";
						hostageActor.fetishStrength = 65;
					...
					case "Youth Preferentialism":
						...
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "adores women";
						hostageActor.sexualQuirk = "romantic";
						hostageActor.fetishStrength = 65;
					...
					case "Slimness Enthusiasm":
						...
						hostageActor.behavioralFlaw = "gluttonous";
						hostageActor.sexualQuirk = "size queen";
						r.push(`getting out of bed and immediately falling to the floor under the weight of ${his} immense ${hostageActor.boobs}cc breasts. ${He} quickly calls out, not for help, but for a dick in ${him} to celebrate this occasion.`);
						break;
					case "Asset Expansionism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						...
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "fitness";
						hostageActor.sexualQuirk = "tease";
					...
					case "Cummunism":
						...
						hostageActor.behavioralFlaw = "gluttonous";
						hostageActor.sexualFlaw = "crude";
						r.push(`getting out of bed and immediately falling to the floor under the weight of ${his} immense ${hostageActor.boobs}cc breasts. As ${his} meaty body jiggles and a veritable flood of milk escapes ${his} breasts; ${he} calls out, not for help, but for a dick in ${him} to celebrate this occasion.`);
						break;
					case "Physical Idealism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.weight = 75;
						hostageActor.boobs += 100;
						hostageActor.butt = 5;
						hostageActor.fetishStrength = 65;
						hostageActor.behavioralFlaw = "gluttonous";
						hostageActor.sexualFlaw = "crude";
						hostageActor.counter.vaginal += 35;
						hostageActor.vagina = 3;
						hostageActor.vaginaTat = "lewd crest";
						...
						switch (hostageActor.fetish) {
							case "cumslut":
								hostageActor.counter.oral += 70;
								break;
							case "buttslut":
								hostageActor.counter.anal += 21;
								hostageActor.anus = 3;
								break;
							case "boobs":
								hostageActor.boobs += 100;
								hostageActor.boobsImplant += 100;
								if (hostageActor.boobsImplant > 2000) {
									hostageActor.boobsImplantType = "advanced fillable";
								}
								break;
							case "pregnancy":
								hostageActor.preg++;
								hostageActor.pregKnown = 1;
								hostageActor.pregWeek = hostageActor.preg;
								SetBellySize(hostageActor);
								break;
						}
						break;
					...
					case "Chattel Religionism":
						...
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "cutting";
						hostageActor.sexualQuirk = "unflinching";
						r.push(`eagerly getting ready to spend some time in the city.`);
						break;
					case "Multiculturalism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 25;
						hostageActor.counter.vaginal += 25;
						hostageActor.counter.anal += 25;
						hostageActor.counter.mammary += 25;
						hostageActor.fetishStrength = 65;
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralFlaw = "devout";
						hostageActor.sexualQuirk = "caring";
					...
					case "Intellectual Dependency":
						...
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.intelligenceImplant = Math.clamp(hostageActor.intelligenceImplant + 2, 0, 30);
						hostageActor.skill.oral = Math.clamp(hostageActor.skill.oral + 5, 0, 100);
						hostageActor.skill.entertainment = Math.clamp(hostageActor.skill.entertainment + 5, 0, 100);
						hostageActor.skill.anal = Math.clamp(hostageActor.skill.anal + 5, 0, 100);
						hostageActor.skill.vaginal = Math.clamp(hostageActor.skill.vaginal + 5, 0, 100);
					...
					case "Slave Professionalism":
						...
						hostageActor.devotion += 5;
						hostageActor.intelligenceImplant = Math.clamp(hostageActor.intelligenceImplant - 5, 0, 30);
						hostageActor.intelligence = Math.clamp(hostageActor.intelligence - 10, -100, 100);
						hostageActor.skill.oral = 0;
						hostageActor.skill.entertainment = 0;
						hostageActor.skill.anal = 0;
						hostageActor.skill.vaginal = 0;
						hostageActor.skill.penetrative = 0;
						hostageActor.skill.whoring = 0;
						hostageActor.skill.combat = 0;
						hostageActor.makeup = 4;
						hostageActor.nails = 5;
						hostageActor.shoes = "heels";
						hostageActor.counter.oral += 50;
						hostageActor.counter.vaginal += 50;
						hostageActor.counter.anal += 50;
						hostageActor.vagina = 3;
					...
					case "Statuesque Glorification":
						...
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 5;
						hostageActor.counter.vaginal += 15;
						hostageActor.counter.anal += 15;
						hostageActor.behavioralFlaw = "none";
						hostageActor.sexualFlaw = "none";
						hostageActor.behavioralQuirk = "advocate";
						hostageActor.sexualQuirk = "caring";
				...
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
						hostageActor.counter.oral += 40;
						hostageActor.counter.vaginal += 40;
						hostageActor.counter.anal += 20;
						hostageActor.fetishStrength = 100;
					...
					case "Racial Supremacism":
						hostageActor.trust += 5;
						hostageActor.devotion += 5;
						if (hostageActor.preg < 20 && V.seePreg !== 0) {
							hostageActor.preg = 25;
							hostageActor.pregType = 1;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = hostageActor.preg;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
						...
						if (hostageActor.vagina < 4) {
							hostageActor.vagina = 4;
						}
						if (hostageActor.anus < 4) {
							hostageActor.anus = 4;
						}
						hostageActor.sexualFlaw = "self hating";
						hostageActor.counter.oral += 50;
						hostageActor.counter.vaginal += 50;
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
					...
					case "Eugenics":
						if (V.seeHyperPreg !== 1) {
							...
							hostageActor.counter.mammary += 100;
							hostageActor.fetishStrength = 100;
							hostageActor.sexualFlaw = "breeder";
							...
							hostageActor.fetishStrength = 100;
							hostageActor.sexualFlaw = "breeder";
							hostageActor.bellySag = 2;
							hostageActor.bellySagPreg = 2;
					...
					case "Gender Fundamentalism":
						...
						if (V.seeDicks !== 0) {
							hostageActor.dick = 3;
							hostageActor.balls = 2;
							hostageActor.scrotum = 1;
							hostageActor.skill.penetrative = Math.clamp(hostageActor.skill.penetrative + 5, 0, 100);
							hostageActor.counter.penetrative += 10;
						}
						hostageActor.fetishStrength = 100;
						hostageActor.sexualFlaw = "anal addict";
					...
					case "Paternalism":
						...
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						eyeSurgery(hostageActor, "both", "blind");
						hostageActor.piercing.ear.weight = 2;
						hostageActor.piercing.nose.weight = 2;
						hostageActor.piercing.nipple.weight = 2;
						hostageActor.piercing.lips.weight = 1;
						hostageActor.piercing.vagina.weight = 1;
						hostageActor.piercing.anus.weight = 1;
						hostageActor.piercing.genitals.weight = 1;
						hostageActor.piercing.eyebrow.weight = 2;
						hostageActor.piercing.navel.weight = 2;
						hostageActor.piercing.corset.weight = 1;
						hostageActor.piercing.areola.weight = 1;
						hostageActor.piercing.tongue.weight = 2;
						hostageActor.lipsTat = "degradation";
						hostageActor.anusTat = "degradation";
						if (seed < 40) {
							App.Medicine.Modification.addScar(hostageActor, "left breast", "burn", 2);
						} else if (seed < 80) {
							App.Medicine.Modification.addScar(hostageActor, "right breast", "burn", 2);
						} else {
							App.Medicine.Modification.addScar(hostageActor, "left breast", "burn", 2);
							App.Medicine.Modification.addScar(hostageActor, "right breast", "burn", 2);
							App.Medicine.Modification.addScar(hostageActor, "belly", "burn", 2);
						}
						/* Next scene will mention nasty surgical arm scars, but immediately amputate, so adding them here. */
						App.Medicine.Modification.addScar(hostageActor, "left upper arm", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "right upper arm", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "left thigh", "surgical", 2);
						App.Medicine.Modification.addScar(hostageActor, "right thigh", "surgical", 2);
						hostageActor.fetishStrength = 100;
					...
					case "Body Purism":
						...
						hostageActor.fetishStrength = 100;
						hostageActor.sexualFlaw = "breast growth";
						r.push(`getting ${his} taut ${hostageActor.boobs}cc tits massaged by a pair of flat slaves. ${He} is rambling on about how much happier ${he} is with ${his} massive implants than when ${he} was flat like them.`);
						break;
					case "Transformation Fetishism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
					...
					case "Slimness Enthusiasm":
						...
						hostageActor.fetishStrength = 100;
						hostageActor.sexualFlaw = "breast growth";
						r.push(`getting ${his} immobilizing ${hostageActor.boobs}cc breasts massaged by a pair of flat slaves. ${He} is rambling on about how much happier ${he} is with ${his} massive tits and ass than when ${he} was flat like them.`);
						break;
					case "Asset Expansionism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
					...
					case "Cummunism":
						...
						hostageActor.fetishStrength = 100;
						hostageActor.sexualFlaw = "breast growth";
						r.push(`getting ${his} immobilizing ${hostageActor.boobs}cc breasts, massive ass, and cow-like body massaged by a trio of slim slaves. ${He} is rambling on about how much happier ${he} is with ${his} massive assets than when ${he} was thin like them.`);
						break;
					case "Physical Idealism":
						hostageActor.trust -= 5;
						hostageActor.devotion -= 5;
					...
					case "Multiculturalism":
						...
						hostageActor.counter.mammary += 50;
						hostageActor.fetishStrength = 100;
						hostageActor.sexualFlaw = "neglectful";
				...
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						...
						break;
					case "Racial Supremacism":
						if (hostageActor.preg < 35 && V.seePreg !== 0) {
							hostageActor.preg = 32;
							hostageActor.pregType = 1;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = hostageActor.preg;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
						...
						/* Make scars worse: */
						App.Medicine.Modification.addScourged(hostageActor);
						App.Medicine.Modification.addScar(hostageActor, "left cheek", "generic", 3);
						App.Medicine.Modification.addScar(hostageActor, "right cheek", "generic", 3);
						App.Medicine.Modification.addScar(hostageActor, "left lower arm", "generic", 2);
						App.Medicine.Modification.addScar(hostageActor, "right lower arm", "generic", 3);
					...
					case "Eugenics":
						if (V.seeHyperPreg !== 1) {
							...
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
							SetBellySize(hostageActor);
							hostageActor.vagina = 5;
							if (hostageActor.counter.births < 1) {
								hostageActor.counter.births = 1;
								hostageActor.counter.birthsTotal += 1;
							}
							hostageActor.counter.oral += 100;
							hostageActor.counter.vaginal += 100;
							hostageActor.counter.anal += 100;
							...
							SetBellySize(hostageActor);
							hostageActor.vagina = 5;
							if (hostageActor.counter.births < 50) {
								hostageActor.counter.births = 20;
								hostageActor.counter.birthsTotal += 20;
							}
							hostageActor.counter.oral += 100;
							hostageActor.counter.vaginal += 100;
							hostageActor.counter.anal += 100;
							hostageActor.counter.mammary += 100;
							hostageActor.bellySag = 5;
							hostageActor.bellySagPreg = 5;
						}
					...
					case "Gender Radicalism":
						...
						r.push(`giving an interview. ${He} gushes over how great it feels knowing that someone is always watching out for ${his} safety and health as a traditional ${hostageActor.actualAge < 16 ? `${girl}` : `${woman}`}, as well as how terrible it is that some people want to blur the lines between the genders.`);
						break;
					case "Gender Fundamentalism":
						hostageActor.counter.anal += 10;
						if (V.seeDicks !== 0) {
							hostageActor.dick = 4;
							hostageActor.balls = 4;
							hostageActor.scrotum = 2;
							hostageActor.skill.penetrative = Math.clamp(hostageActor.skill.penetrative + 5, 0, 100);
							hostageActor.counter.penetrative += 10;
						}
					...
					case "Paternalism":
						...
						hostageActor.counter.anal += 50;
						hostageActor.counter.mammary += 50;
						removeLimbs(hostageActor, "all");
						hostageActor.piercing.ear.weight = 2;
						hostageActor.piercing.nose.weight = 2;
						hostageActor.piercing.nipple.weight = 2;
						hostageActor.piercing.lips.weight = 2;
						hostageActor.piercing.vagina.weight = 2;
						hostageActor.piercing.anus.weight = 2;
						hostageActor.piercing.genitals.weight = 2;
						hostageActor.piercing.eyebrow.weight = 2;
						hostageActor.piercing.navel.weight = 2;
						hostageActor.piercing.corset.weight = 1;
						hostageActor.piercing.areola.weight = 1;
						hostageActor.piercing.tongue.weight = 2;
						if (seed < 40) {
							App.Medicine.Modification.addScar(hostageActor, "anus", "burn", 2);
						} else if (seed < 80) {
							App.Medicine.Modification.addScar(hostageActor, "vagina", "burn", 2);
						} else {
							App.Medicine.Modification.addScar(hostageActor, "anus", "burn", 2);
							App.Medicine.Modification.addScar(hostageActor, "vagina", "burn", 2);
							App.Medicine.Modification.addScar(hostageActor, "left cheek", "burn", 2);
						}
					...
					case "Degradationism":
						hostageActor.counter.vaginal += 1;
						if (V.seePreg !== 0) {
							hostageActor.preg = 14;
							hostageActor.pregType = 1;
							hostageActor.pregKnown = 1;
							hostageActor.pregWeek = 14;
							WombImpregnate(hostageActor, hostageActor.pregType, SID.GENERIC, hostageActor.preg);
							SetBellySize(hostageActor);
						}
						...
						break;
					case "Body Purism":
						hostageActor.boobs = 50000;
						hostageActor.boobsImplant = 45000;
						hostageActor.boobsImplantType = "hyper fillable";
					...
					case "Cummunism":
						...
						break;
					case "Physical Idealism":
						hostageActor.weight = 150;
						hostageActor.boobs += 100;
						hostageActor.butt = 6;
						hostageActor.fetishStrength = 100;
						hostageActor.counter.vaginal += 60;
						hostageActor.vagina = 5;
						r.push(`moaning as ${he} shoves food into ${his} mouth with one hand and fondles ${his} lover's body with the other. "My apologies. I don't have ${his} weight for you this week. You see, ${he} broke the scale when ${he} stepped on it. Well, I suppose that tells you plenty. Though I have another surprise for you! ${SlaveFullName(hostageActor)}, would you like to tell 'em yourself?" ${He} shouts, spewing crumbs everywhere,`);
						switch (hostageActor.fetish) {
							case "submissive":
								r.push(Spoken(hostageActor, `"I haven't orgasmed all week, but I've made sure to bring every one of my lovers to climax! That's what I love most, seeing the look of satisfaction on their faces as they blow their loads deep into me!"`));
								hostageActor.sexualFlaw = "neglectful";
								break;
							case "cumslut":
								r.push(Spoken(hostageActor, `"I suck dicks all day and have cum mixed in with my many meals but it still isn't enough! If I could, I'd drink cum till I burst!"`));
								hostageActor.counter.oral += 70;
								hostageActor.sexualFlaw = "cum addict";
								break;
							case "humiliation":
								r.push(Spoken(hostageActor, `"I love taking part in orgies and being the center of attention! You can't possible know what it feels like to pleasure fifteen guys at once!"`));
								hostageActor.sexualFlaw = "attention whore";
								break;
							case "buttslut":
								r.push(Spoken(hostageActor, `"I love it up the butt! I get assfucked all day long and when I don't have a dick in my rear, I have the biggest dildo we've got rammed up it!"`));
								hostageActor.counter.anal += 45;
								hostageActor.anus = 4;
								hostageActor.sexualFlaw = "anal addict";
								break;
							case "boobs":
								r.push(Spoken(hostageActor, `"I love my big boobs and get off watching them get bigger!"`));
								hostageActor.boobs += 100;
								hostageActor.boobsImplant += 100;
								if (hostageActor.boobsImplant > 2000) {
									hostageActor.boobsImplantType = "advanced fillable";
								...
								break;
							case "sadist":
								r.push(Spoken(hostageActor, `"Nothing turns me on more than crushing my lovers' nuts! That or maybe whipping or cutting them... Or anything that makes them bleed..."`));
								hostageActor.sexualFlaw = "malicious";
								break;
							case "masochist":
								r.push(Spoken(hostageActor, `"I love just stuffing my face with the fattiest foods around! I'm going to have a heart attack and I can't wait since I am such a disgusting slut and I deserve this!"`));
								hostageActor.sexualFlaw = "self hating";
								break;
							case "dom":
								r.push(Spoken(hostageActor, `"Nothing turns me on more than forcing new slaves to service me! I love their reactions as they struggle against me!"`));
								hostageActor.sexualFlaw = "abusive";
								break;
							case "pregnancy":
								r.push(Spoken(hostageActor, `"I'm preggers you know! ${hostageActor.preg} weeks along now and you know what? I always want to be pregnant! Always!"`));
								hostageActor.preg++;
								hostageActor.pregKnown = 1;
								hostageActor.pregWeek++;
								SetBellySize(hostageActor);
					...
					case "Intellectual Dependency":
						...
						hostageActor.counter.vaginal += 10;
						hostageActor.counter.anal += 10;
						hostageActor.intelligenceImplant = 30;
						hostageActor.skill.oral = 100;
						hostageActor.skill.entertainment = 100;
						hostageActor.skill.anal = 100;
						hostageActor.skill.vaginal = 100;
						hostageActor.skill.whoring = 100;
						...
						break;
					case "Slave Professionalism":
						hostageActor.intelligenceImplant = 0;
						hostageActor.intelligence = -100;
						hostageActor.counter.oral += 100;
						hostageActor.counter.vaginal += 100;
						hostageActor.counter.anal += 100;
						hostageActor.energy = 100;
						hostageActor.lips = Math.clamp(hostageActor.lips + 5, 0, 100);
				...
				switch (V.rival.FS.name) {
					case "Racial Subjugationism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} and ${his} lovers someplace far away. Someplace you'll never find them. Bet tha"`);
						break;
					case "Racial Supremacism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, the poor bitch died`);
						if (V.seePreg !== 0) {
						...
						break;
					case "Repopulation Focus":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. Someplace you'll never find ${him}. Bet tha"`);
						break;
					case "Eugenics":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. Someplace you'll never find ${him}. Bet tha"`);
						break;
					case "Gender Radicalism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. I'll miss ${him}, of course, but there is no way I'd let you have ${him}. Bet that piss"`);
						break;
					case "Gender Fundamentalism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, ${he} took a dick a little too big for ${his} ass and ruined ${his} sphincter. ${He}'s off, someplace far away, recovering. But I'll never tell you where, bet that piss"`);
						break;
					case "Paternalism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, ${he} got kicked around just a little too much. We had lots of fun with ${him}, before ${he} broke of course... Say, do you have anyone else you love, or even were familiar with? I should acquire them, keep our little game goi"`);
						break;
					case "Degradationism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. I'll miss ${him}, of course, but there is no way I'd let you have ${him}. I'll keep ${him} saf"`);
						break;
					case "Body Purism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, apparently implants can be too big. ${His} breasts literally popped, couldn't save ${him} though. Definitely going to miss playing with those balloons. I should hunt down more people you knew, keep our little game goi"`);
						break;
					case "Transformation Fetishism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. Someplace you'll never find ${him}. Bet tha"`);
						break;
					case "Youth Preferentialism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} and ${his} lover someplace far away. Someplace you'll never find them. Bet tha"`);
						break;
					case "Maturity Preferentialism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} and ${his} lover someplace far away. Someplace you'll never find them. Bet tha"`);
						break;
					case "Slimness Enthusiasm":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, apparently those growth drugs have quite the side effects. Pretty much had cancer everywhere. Definitely going to miss playing with those milkbags, though. I should hunt down more people you knew, keep our little game goi"`);
						break;
					case "Asset Expansionism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. Someplace you'll never find ${him}. Bet tha"`);
						break;
					case "Pastoralism":
						...
						break;
					case "Physical Idealism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, apparently being that fat isn't good for your heart, who knew? Definitely going to miss playing with those folds; ${he} jiggled so much when I fucked ${him}. I should hunt down more people you knew, fatten them up, keep our little game goi"`);
						break;
					case "Hedonistic Decadence":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} far away. I'll miss ${him}, of course, but there is no way I'd let you have ${him}. Bet that piss"`);
						break;
					case "Chattel Religionism":
						...
						break;
					case "Multiculturalism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, ${he} decided to martyr ${himself} for your arcology's salvation. Got fucked till ${his} body gave out. Of course I enjoyed ${him} in ${his} final moments, and don't worry, ${he} died smiling. I should hunt down more people you knew, keep our little game goi"`);
						break;
					case "Intellectual Dependency":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, ${he} ran the math and determined that the odds of me keeping ${him} through this were too low and that ${he} should go into hiding until it's safe to come back. ${He}'s a well trained ${girl} now, so I trust ${him}, and even if I did lose this war, it'd still be worth taking ${his} advice just to deny you your prize. Bet tha"`);
						break;
					case "Slave Professionalism":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, bitch was so dumb ${he} couldn't understand the warning signs, rushed down some slick stairs for a fuck and broke ${his} neck. ${He} was fun, no denying that. Died the way ${he} lived, thinking of sucking cock. Not unlike you, act"`);
						break;
					case "Petite Admiration":
						r.push(`"Looking for ${SlaveFullName(hostageActor)}? Too bad, I couldn't bear to think of you ever getting your rotten little hands on ${him}, so I sent ${him} and ${his} lover someplace far away. Someplace you'll never find them. Bet tha"`);
						break;
				...
				switch (V.rival.FS.name) {
					...
					case "Body Purism":
						if (V.rival.duration <= 5) {
							...
							hostageAction.push(`trying desperately to stand despite ${his} massive ${hostageActor.boobs}cc fake tits.`);
							hostageAction.push(`crying while trying to get comfortable with ${his} ${hostageActor.boobs}cc fake tits.`);
							hostageAction.push(`sobbing as an autosurgery reads out how much ${his} ${hostageActor.boobs}cc implants can be expanded this week.`);
						} else if (V.rival.duration <= 10) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.fetishStrength += 5;
							...
							hostageAction.push(`reluctantly exploring ${his} new massive ${hostageActor.boobs}cc implants.`);
							hostageAction.push(`reluctantly exploring new resting positions due to ${his} ${hostageActor.boobs}cc implants.`);
							hostageAction.push(`crying as an autosurgery reads out how much ${his} ${hostageActor.boobs}cc implants can be expanded this week.`);
						} else if (V.rival.duration <= 15) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.fetishStrength += 5;
							...
							hostageAction.push(`happily playing with ${his} truly immense ${hostageActor.boobs}cc breast implants and huge butt implants.`);
							hostageAction.push(`happily resting ${his} head on ${his} ${hostageActor.boobs}cc breast implants.`);
							hostageAction.push(`blushing as an autosurgery reads out how much ${his} ${hostageActor.boobs}cc implants can be expanded this week.`);
						} else if (V.rival.duration <= 20) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.boobs += 1000;
							...
							hostageAction.push(`happily getting titfucked against ${his} anchoring ${hostageActor.boobs}cc fake tits.`);
							hostageAction.push(`contently resting against ${his} ${hostageActor.boobs}cc fake tits.`);
							hostageAction.push(`getting excited as an autosurgery reads out how much ${his} ${hostageActor.boobs}cc implants can be expanded this week.`);
						} else {
							hostageAction.push(`resting on ${his} monstrous ${hostageActor.boobs}cc fake tits, whining about not being allowed larger implants.`);
							hostageAction.push(`resting atop ${his} monstrous ${hostageActor.boobs}cc fake tits, daydreaming about being even bigger.`);
							hostageAction.push(`throwing a fit that ${his} ${hostageActor.boobs}cc fake tits are too big to expand further.`);
							hostageAction.push(`throwing a fit that ${his} ${hostageActor.boobs}cc fake tits stick out too far to allow ${him} to squeeze into the surgery suite.`);
						}
						break;
					case "Transformation Fetishism":
						if (V.rival.duration <= 5) {
					...
					case "Slimness Enthusiasm":
						if (V.rival.duration <= 5) {
							...
							hostageActor.weight += 5;
							hostageActor.boobs += 1500;
							hostageAction.push(`trying desperately to stand despite ${his} massive ${hostageActor.boobs}cc tits.`);
							hostageAction.push(`crying over ${his} swollen breasts and butt.`);
							hostageAction.push(`weeping as the breast injections swell ${his} breasts to ${hostageActor.boobs}ccs.`);
						} else if (V.rival.duration <= 10) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.fetishStrength += 5;
							hostageActor.weight += 5;
							hostageActor.boobs += 1000;
							hostageAction.push(`reluctantly exploring ${his} new massive ${hostageActor.boobs}cc tits, bigger bottom, and softer body.`);
							hostageAction.push(`cringing as ${he} feels ${his} huge soft tits and ass.`);
							hostageAction.push(`cringing as the breast injections swell ${his} breasts to ${hostageActor.boobs}ccs along with ${his} butt.`);
						} else if (V.rival.duration <= 15) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.fetishStrength += 5;
							hostageActor.weight += 5;
							hostageActor.boobs += 1000;
							hostageAction.push(`happily playing with ${his} truly immense ${hostageActor.boobs}cc breasts and huge butt.`);
							hostageAction.push(`giggling as ${he} gropes ${his} soft body.`);
							hostageAction.push(`smiling as the breast injections swell ${his} breasts to ${hostageActor.boobs}ccs. ${He} runs ${his} hand across ${his} huge butt and softening body.`);
						} else if (V.rival.duration <= 20) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.weight += 5;
							hostageActor.boobs += 1000;
							hostageAction.push(`happily getting titfucked in ${his} immobilizing ${hostageActor.boobs}cc tits.`);
							hostageAction.push(`happily massaging ${his} super soft body and huge assets.`);
							hostageAction.push(`practically orgasming as the breast injections swell ${his} breasts to ${hostageActor.boobs}ccs. ${He} sinks ${his} hands into ${his} enormous butt and soft belly.`);
						} else {
							hostageAction.push(`resting atop ${his} monstrous ${hostageActor.boobs}cc tits, whining about not being allowed to have ${his} assets swollen more.`);
							hostageAction.push(`resting in ${his} own mountainous softness.`);
							hostageAction.push(`shouting at a plastic surgeon to make ${his} ${hostageActor.boobs}cc tits even larger.`);
							hostageAction.push(`attempting to maneuver around ${his} ${hostageActor.boobs}cc tits to reach a drug cabinet for more injections.`);
						}
						break;
					case "Asset Expansionism":
						if (V.rival.duration <= 5) {
					...
					case "Cummunism":
						if (V.rival.duration <= 5) {
							...
							hostageActor.weight += 5;
							hostageActor.boobs += 1000;
							hostageActor.lactation = 2;
							hostageActor.lactationDuration = 2;
							hostageAction.push(`trying desperately to extract the milk from ${his} massive ${hostageActor.boobs}cc tits. ${He} appears to have gained some weight.`);
							hostageAction.push(`sobbing as ${he} massages ${his} sore ${hostageActor.boobs}cc udders.`);
							hostageAction.push(`sobbing as the milkers drain ${his} ${hostageActor.boobs}cc udders.`);
						} else if (V.rival.duration <= 10) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.weight += 5;
							...
							hostageActor.lactation = 2;
							hostageActor.lactationDuration = 2;
							hostageAction.push(`reluctantly asking for ${his} massive ${hostageActor.boobs}cc tits to be milked. ${He}'s certainly getting soft.`);
							hostageAction.push(`crying as rubs ${his} uncomfortably massive ${hostageActor.boobs}cc udders and softening belly.`);
							hostageAction.push(`sighing as the milkers drain ${his} big ${hostageActor.boobs}cc udders while ${he} massages ${his} softening belly.`);
						} else if (V.rival.duration <= 15) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.weight += 5;
							...
							hostageActor.lactation = 2;
							hostageActor.lactationDuration = 2;
							hostageAction.push(`happily asking for ${his} truly immense ${hostageActor.boobs}cc breasts to be milked. ${His} body has become notably plush.`);
							hostageAction.push(`humming as ${he} soothes ${his} truly immense sore ${hostageActor.boobs}cc udders. ${He} lets off a content sigh as ${he} jiggles ${his} soft belly.`);
							hostageAction.push(`sighing with relief as the milkers drain ${his} huge ${hostageActor.boobs}cc udders while ${he} massages ${his} jiggly belly.`);
						} else if (V.rival.duration <= 20) {
							hostageActor.trust -= 5;
							hostageActor.devotion -= 5;
							hostageActor.weight += 5;
							...
							hostageActor.lactation = 2;
							hostageActor.lactationDuration = 2;
							hostageAction.push(`begging for ${his} immobilizing ${hostageActor.boobs}cc tits to be drained. ${He} has become quite fat.`);
							hostageAction.push(`happily playing with ${his} ${hostageActor.boobs}cc udders. ${He} squirms and giggles as ${his} entire body jiggles in response.`);
							hostageAction.push(`happily humming as the milkers drain ${his} giant ${hostageActor.boobs}cc udders while ${he} plays with ${his} fat belly and breasts.`);
						} else {
							hostageActor.lactation = 2;
							hostageActor.lactationDuration = 2;
							hostageAction.push(`resting atop ${his} monstrous ${hostageActor.boobs}cc tits, whining about not being allowed to have ${his} assets swollen more and that ${he} has to squeeze ${his} milk out ${himself}.`);
							hostageAction.push(`moans lewdly as a pair of slaves massage ${his} ${hostageActor.boobs}cc udders, and as a third appears from under ${his} heavy body.`);
							hostageAction.push(`moaning loudly as the milkers drain ${his} massive ${hostageActor.boobs}cc udders.`);
						}
						break;
					case "Physical Idealism":
						if (V.rival.duration <= 5) {
							...
							switch (hostageActor.fetish) {
								...
								case "buttslut":
									...
									break;
								case "boobs":
									hostageAction.push(`struggling to hold back ${his} joy as ${he} checks out ${his} new ${hostageActor.boobsImplant}cc implants.`);
									break;
								case "sadist":
							...
							switch (hostageActor.fetish) {
								...
								case "buttslut":
									...
									break;
								case "boobs":
									hostageAction.push(`happily teasing a dick between ${his} new ${hostageActor.boobsImplant}cc implants.`);
									break;
								case "sadist":
							...
							switch (hostageActor.fetish) {
								...
								case "buttslut":
									...
									break;
								case "boobs":
									hostageAction.push(`groping ${his} already huge ${hostageActor.boobsImplant}cc breasts and begging for them to be even bigger.`);
									break;
								case "sadist":
							...
							switch (hostageActor.fetish) {
								...
								case "buttslut":
									...
									break;
								case "boobs":
									hostageAction.push(`greedily stuffing ${his} face with slave food as a pair of guys double team ${his} ruined pussy. ${He} takes time between bites to hungrily fondle ${his} ${hostageActor.boobs}cc tits.`);
					...
					case "Slave Professionalism":
						if (V.rival.duration <= 5) {
							...
							hostageActor.hLength += 7;
							hostageActor.intelligenceImplant = Math.clamp(hostageActor.intelligenceImplant - 5, 0, 30);
							hostageActor.intelligence = Math.clamp(hostageActor.intelligence - 5, -100, 100);
					...
					case "Petite Admiration":
						if (V.rival.duration <= 5) {
							...
							hostageActor.fetishStrength += 5;
							hostageActor.counter.oral += 7;
							hostageActor.counter.vaginal += 3;
							hostageActor.counter.anal += 3;
					...
					case "Statuesque Glorification":
						if (V.rival.duration <= 5) {
							...
							hostageActor.fetishStrength += 5;
							hostageActor.counter.oral += 7;
							hostageActor.counter.vaginal += 13;
							hostageActor.counter.anal += 13;

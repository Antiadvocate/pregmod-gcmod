App.Events.recPaternalistSwanSong = class recPaternalistSwanSong extends App.Events.BaseEvent {
	...
	execute(node) {
		...
		r.push(Spoken(slave, `"I was told by my producer to come here; they say I have taken on enough of a debt to be enslaved. I heard that slaves seem to be treated well here and thought that, just maybe, if I convinced them to let my final performance be here, I would have a chance at a better life than at another arcology owned by a crueler master. Please, would you consider taking me in?"`));

App.Events.recetsIncestBrotherBrother = class recetsIncestBrotherBrother extends App.Events.BaseEvent {
	eventPrerequisites() {
		return [
			() => V.seeDicks !== 0,
			() => V.seeIncest !== 0,
	...
	execute(node) {
		...
		brother2.dick += 2;
		brother2.balls += 2;
		brother2.scrotum = brother2.balls;

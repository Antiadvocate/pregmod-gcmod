	...
	return {
		get(target, key) {
			switch (key) {
				...
				case "toJSON":
					return () => Serial.createReviver('new Proxy($ReviveData$.slave, _makeGingeredSlaveHandler($ReviveData$.params, $ReviveData$.keys))', {slave: target, params: gParams, keys: gKeys});
			}

...
App.Budget.costs = function() {
	...
	function settings() {
		...
		V.temp.showEmptyBudgetEntries = V.temp.showEmptyBudgetEntries ?? {};
		if (V.temp.showEmptyBudgetEntries.cash === undefined) {
			V.temp.showEmptyBudgetEntries.cash = 0;
		}
		options.addOption("", "cash", V.temp.showEmptyBudgetEntries)

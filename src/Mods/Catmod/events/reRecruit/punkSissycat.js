App.Events.recPunkSissycat = class recPunkSissycat extends App.Events.BaseEvent {
	...
	execute(node) {
		...
		function makeSlave() {
			const slave = GenerateNewSlave("XY", {minAge: 18, maxAge: 28, race: "catgirl"});

...
App.UI.Player.personalAttention = function() {
	...
	function skills() {
		...
		/**
		 * @param {Array<{skill: string, text: string, link: {value: FC.PersonalAttention, text: string}}>} args
		 * @returns {HTMLDivElement}
		 */
	...
	function attention() {
		 ...
		 * @param {number} index
		 * @param {string} text
		 * @param {FC.PersonalAttentionTrainingObjective} target
		 ...
		 * @property {FC.PersonalAttentionTrainingObjective} type
	...
	/**
	 * @param {FC.SlaveState} slave
	 * @returns {FC.PersonalAttentionTrainingObjective}
	 */

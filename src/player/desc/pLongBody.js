App.Desc.Player.body = function(PC = V.PC) {
	...
	function shoulders() {
		...
		if (PC.shouldersImplant > 0) {
			r.push(`They aren't naturally this width, as you have undergone surgery to widen them.`);
		} else if (PC.shouldersImplant < 0) {
			r.push(`They aren't naturally this width, as you have undergone surgery to reduce them.`);
		}

App.Desc.Player.crotch = function(PC = V.PC) {
	...
	function vagina() {
		...
		if (PC.cervixImplant === 3) {
			r.push(`The pump system also replaces your `);
			if (PC.cervixImplantTarget === "all") {
				r.push(`cervix, allowing vaginal sex to steadily make your body more lewd.`);
			} else if (PC.cervixImplantTarget === "TnA") {
				r.push(`cervix, allowing vaginal sex to steadily give you an hourglass body.`);
			} else if (PC.cervixImplantTarget === "mombod") {
				r.push(`cervix, allowing vaginal sex to slowly turn you into a MILF without the need for a baby.`);
			} else if (PC.cervixImplantTarget === "bottomHeavy") {
				r.push(`cervix, allowing vaginal sex to cause your butt and belly to grow.`);
			} else if (PC.cervixImplantTarget === "bellyImplant") {
				r.push(`cervix, allowing vaginal sex to steadily swell your belly by a less conventional method.`);
			} else if (PC.cervixImplantTarget === "boobsImplant") {
				r.push(`cervix, allowing vaginal sex to steadily inflate your breasts.`);
			} else if (PC.cervixImplantTarget === "buttImplant") {
				r.push(`cervix, allowing vaginal sex to steadily give you a little more cushion for the pushing.`);
			} else {
				r.push(`cervix.`);
			}
		} else if (PC.cervixImplant === 1) {
			r.push(`You have a special pump replacing your cervix that converts fluids to inert filler`);
			if (PC.cervixImplantTarget === "all") {
				r.push(`for your implants, allowing vaginal sex to steadily make your body more lewd.`);
			} else if (PC.cervixImplantTarget === "TnA") {
				r.push(`for your breast and butt implants, allowing vaginal sex to convert you into a bombshell.`);
			} else if (PC.cervixImplantTarget === "mombod") {
				r.push(`for your breast and belly implants, allowing vaginal sex to slowly turn you into a MILF without the baby.`);
			} else if (PC.cervixImplantTarget === "bottomHeavy") {
				r.push(`for your butt and belly implants, allowing vaginal sex to slowly round you out.`);
			} else if (PC.cervixImplantTarget === "bellyImplant") {
				r.push(`for your abdominal implant, allowing vaginal sex to steadily swell your belly in a less conventional method.`);
			} else if (PC.cervixImplantTarget === "boobsImplant") {
				r.push(`for your boob implants, causing a little bit of breast expansion each time your vagina gets creampied.`);
			} else if (PC.cervixImplantTarget === "buttImplant") {
				r.push(`for your butt implants, causing vaginal sex to steadily give you a little more cushion for the pushing.`);
			} else {
				r.push(`to expand fillable implants.`);
			}
		}
		if (PC.vaginaLube === 0) {
			if (isAroused) {
	...
	if (PC.ovaries === 1) {
		...
		if (PC.ovaImplant !== 0) {
			if (PC.wombImplant === "restraint") {
				r.push(`Your ovaries are modified as well;`);
			} else {

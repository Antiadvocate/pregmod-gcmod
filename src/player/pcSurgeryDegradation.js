...
/**
 * @param {FC.Medicine.Surgery.Type} surgeryType the type of surgery to describe
...
App.UI.PCSurgeryDegradation = function(surgeryType) {
	...
	switch (surgeryType) {
		...
		case "ageDown":
			...
			V.PC.visualAge = Math.round(18.5 * Math.log(V.PC.visualAge) - 40);
			break;
		case "ageUp":
			...
			V.PC.visualAge = Math.round(0.8 * V.PC.visualAge + 16);
			break;
		case "faceUp":
			faceIncreaseAction(V.PC, 20);
			break;
		case "lipEnlargement":
		case "lipEnlargementImplant":
			r.push(`You have surgery. This is a WIP, needed for clamping values.`);
			V.PC.lips = Math.min(100, V.PC.lips);
			V.PC.lipsImplant = Math.min(100, V.PC.lipsImplant);
			break;
		case "lipReduction":
			r.push(`You have surgery. This is a WIP, needed for clamping values.`);
			V.PC.lips = Math.max(0, V.PC.lips);
			V.PC.lipsImplant = Math.max(0, V.PC.lipsImplant);
			break;

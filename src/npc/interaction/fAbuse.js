		...
		if (!hasAnyArms(slave)) {
			...
			switch (slave.clothes) {
				...
				case "a nipple bikini":
					r.push(`${He} quickly rips off ${his} bikini.`);
					break;
				...
				case "a bimbo outfit":
					...
					break;
				case "slave rags":
					r.push(`${He} quickly tears off ${his} rags.`);
					break;
				case "a slutty magical girl costume":
					r.push(`${His} skirt comes off quickly enough, but the bodysuit was designed to be worn during sex and trips ${him} up as ${he} tries to remove it.`);
					break;
				// WIP
				...
				case "a turtleneck and miniskirt":
					r.push(`${He} does what ${he} can to get undressed in time.`);
					break;
				// end WIP
			}
		}

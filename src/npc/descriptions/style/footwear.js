		...
		switch (slave.clothes) {
			...
			case "slave rags":
				switch (slave.shoes) {
					case "flats":
						if (bothFeet) {
							r.push(`a pair of old sandals.`);
						} else {
							r.push(`an old sandal.`);
						}
						break;
					case "boots":
						if (bothFeet) {
							r.push(`a pair of worn leather boots.`);
						} else {
							r.push(`a worn leather boot.`);
						}
						break;
					case "heels":
						if (bothFeet) {
							r.push(`a pair of worn heels.`);
						} else {
							r.push(`a worn heel.`);
						}
						break;
					...
					case "extreme heels":
						if (bothFeet) {
							r.push(`a pair of questionable high heels.`);
						} else {
							r.push(`a questionable high heel.`);
						}
						break;
					case "platform shoes":
						if (bothFeet) {
							r.push(`a pair of worn platform shoes.`);
						} else {
							r.push(`a worn platform shoe.`);
						}
						break;
					case "platform heels":
						if (bothFeet) {
							r.push(`a pair of worn platform heels.`);
						} else {
							r.push(`a worn platform heel.`);
						}
						break;
					case "extreme platform heels":
						if (bothFeet) {
							r.push(`a pair of sketchy high platform heels.`);
						} else {
							r.push(`a sketchy high platform heel.`);
						}
						break;
					default:
						if (bothFeet) {
			...
			case "a slutty magical girl costume":
				switch (slave.shoes) {
					case "flats":
						if (bothFeet) {
							r.push(`a pair of colorful cute flats.`);
						} else {
							r.push(`a cute colorful flat shoe.`);
						}
						break;
					case "boots":
						if (bothFeet) {
							r.push(`a pair of colorful cute little ankle boots.`);
						} else {
							r.push(`a colorful cute little ankle boot.`);
						}
						break;
					case "heels":
						if (bothFeet) {
							r.push(`a pair of colorful sexy heels.`);
						} else {
							r.push(`a colorful sexy heel.`);
						}
						break;
					case "pumps":
						if (bothFeet) {
							r.push(`a pair of colorful sexy pumps.`);
						} else {
							r.push(`a colorful sexy heel.`);
						}
						break;
					case "extreme heels":
						if (bothFeet) {
							r.push(`a pair of colorful high stripper heels.`);
						} else {
							r.push(`a colorful high stripper heel.`);
						}
						break;
					case "platform shoes":
						if (bothFeet) {
							r.push(`a pair of colorful heart-shaped platforms.`);
						} else {
							r.push(`a colorful heart-shaped platform shoe.`);
						}
						break;
					case "platform heels":
						if (bothFeet) {
							r.push(`a pair of colorful heart-shaped heels.`);
						} else {
							r.push(`a colorful heart-shaped heel.`);
						}
						break;
					case "extreme platform heels":
						if (bothFeet) {
							r.push(`a pair of colorful high stripper platform heels`);
						} else {
							r.push(`a colorful high stripper platform heel`);
						}
						r.push(`so tall`);
						if (canStand(slave)) {
							r.push(`that ${he} must stick ${his} ass and chest out to stand.`);
			...
			case "a turtleneck and miniskirt":
				switch (slave.shoes) {
					case "flats":
						if (bothFeet) {
							r.push(`a pair of simple sandals.`);
						} else {
							r.push(`a simple sandal.`);
						}
						break;
					case "boots":
						if (bothFeet) {
							r.push(`a pair of sexy leather boots.`);
						} else {
							r.push(`a sexy leather boot.`);
						}
						break;
					case "heels":
						if (bothFeet) {
					...
					case "extreme platform heels":
						if (bothFeet) {
							...
							r.push(`a daringly high platform heel.`);
						}
						break;
					default:
						if (bothFeet) {
		...
		switch (slave.legAccessory) {
			...
			case "short stockings":
				switch (slave.clothes) {
					...
					case "slave rags":
						if (hasBothLegs(slave)) {
							r.push(`${He} is wearing a pair of ragged short stockings.`);
						} else {
							r.push(`${He} is wearing a ragged short stocking.`);
						}
						break;
					case "a slutty magical girl costume":
						if (hasBothLegs(slave)) {
							r.push(`${He} is wearing a pair of short color-matched stockings that end just below ${his} knees.`);
						} else {
							r.push(`${He} is wearing a short color-matched stocking that ends just below ${his} knee.`);
						}
						break;
					default:
						if (hasBothLegs(slave)) {
			...
			case "long stockings":
				switch (slave.clothes) {
					...
					case "slave rags":
						if (hasBothLegs(slave)) {
							r.push(`${He} is wearing a pair of long, ragged stockings that come up to the middle of ${his} thighs.`);
						} else {
							r.push(`${He} is wearing a long, ragged stocking that comes up to the middle of ${his} thigh.`);
						}
						break;
					case "a slutty magical girl costume":
						if (hasBothLegs(slave)) {
							r.push(`${He} is wearing a pair of long, color-matched stockings that come up to the top of ${his} thighs.`);
						} else {
							r.push(`${He} is wearing a long, color-matched stocking that comes up to the top of ${his} thigh.`);
						}
						break;
					default:
						if (hasBothLegs(slave)) {

		...
		switch (slave.armAccessory) {
				...
				switch (slave.clothes) {
					case "slave rags":
						if (hasBothArms(slave)) {
							r.push(`${He} is wearing a pair of worn gloves on ${his} hands.`);
						} else {
							r.push(`${He} is wearing a worn glove on ${his} hand.`);
						}
						break;
					case "a slutty magical girl costume":
						if (hasBothArms(slave)) {
							r.push(`${He} is wearing a pair of color-matched gloves that cover ${his} hands up to ${his} wrists.`);
						} else {
							r.push(`${He} is wearing a color-matched glove that covers ${his} hand up to its wrist.`);
						}
						break;
					default:
						if (hasBothArms(slave)) {
			...
			case "elbow gloves":
				switch (slave.clothes) {
					...
					case "slave rags":
						if (hasBothArms(slave)) {
							r.push(`${He} is wearing a pair of worn long gloves that cover ${his} arms until just past ${his} elbows.`);
						} else {
							r.push(`${He} is wearing a worn long glove that covers ${his} arm until just past its elbow.`);
						}
						break;
					case "a slutty magical girl costume":
						if (hasBothLegs(slave)) {
							r.push(`${He} is wearing a pair of long color-matched gloves that end just past ${his} elbows.`);
						} else {
							r.push(`${He} is wearing a long color-matched glove that ends just past ${his} elbow.`);
						}
						break;
					default:
						if (hasBothArms(slave)) {

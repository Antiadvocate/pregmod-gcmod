...
App.Desc.clothingCorset = function(slave) {
	...
	if (clothing && clothing.desc && "clothingCorset" in clothing.desc) {
		...
		switch (slave.clothes) {
			...
			case "slave rags":
				if (slave.bellyAccessory === "a corset") {
					r.push(`${His} sturdy corset is worn, but functional.`);
				} else if (slave.bellyAccessory === "an extreme corset") {
					r.push(`${His} extreme corsetage is well worn, but still functional.`);
				} else if (slave.bellyAccessory === "a support band") {
					r.push(`${His} support band is worn, but functional.`);
				}
				break;
			case "a slutty magical girl costume":
				if (slave.bellyAccessory === "a corset") {
					r.push(`${His} color-matched corset is worn over ${his} bodysuit.`);
				} else if (slave.bellyAccessory === "an extreme corset") {
					r.push(`${His} color-matched absurd corset is worn over ${his} bodysuit.`);
				} else if (slave.bellyAccessory === "a support band") {
					r.push(`${His} color-matched support band is almost rendered redundant by ${his} form-hugging bodysuit.`);
				}
				break;
			// WIP
			case "a valkyrie outfit":
				if (slave.bellyAccessory === "a corset") {
					r.push(`The corset is an integral part of ${his} armored top.`);
				} else if (slave.bellyAccessory === "an extreme corset") {
					r.push(`The extreme corset is an integral part of ${his} armored top.`);
				} else if (slave.bellyAccessory === "a support band") {
					r.push(`${His} support band is barely visible, since it's covered by ${his} armored top.`);
				}
				break;
			case "a coat and corset":
				if (slave.bellyAccessory === "a corset") {
					r.push(`The corset is clearly visible if ${he} opens ${his} coat.`);
				} else if (slave.bellyAccessory === "an extreme corset") {
					r.push(`The extreme corset is clearly visible if ${he} opens ${his} coat.`);
				} else if (slave.bellyAccessory === "a support band") {
					r.push(`${His} support band is barely visible, since it's covered by ${his} corset.`);
				}
				break;
			case "a tribal outfit":
			case "a samba outfit":
				if (slave.bellyAccessory === "a corset") {
					r.push(`The corset is clearly visible and is similarly ornamented with beads.`);
				} else if (slave.bellyAccessory === "an extreme corset") {
					r.push(`The extreme corset is clearly visible and is similarly ornamented with beads.`);
				} else if (slave.bellyAccessory === "a support band") {
					r.push(`${His} support band is barely visible, since it looks like an ornamented belly chain.`);
				}
				break;

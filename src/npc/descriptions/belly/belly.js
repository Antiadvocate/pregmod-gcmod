			...
			if (descType !== DescType.SURGERY) {
				...
				if (FutureSocieties.isActive('FSRepopulationFocus')) {
					...
					if (slave.belly >= 1000000) {
						...
						if (isBreeder && slave.pregSource === SID.PC) {
							r.push(`Your eugenics obsessed society is pleased that ${he} is ripe with your child.`);
						} else if (isBreeder && slave.pregSource === SID.ELITE) {
				...
				case "slave rags":
					...
					// WIP//
						...
						if (isBellyFluidLargest) {
							...
							r.push(`${slave.slaveName}'s giant implant-filled belly takes full advantage of ${his} exposed midriff to bulge heavily out from ${his} body while threatening to snap the frayed cord keeping ${his} modesty rag up.`);
						} else {
							r.push(`${slave.slaveName}'s giant pregnant belly takes full advantage of ${his} exposed midriff to bulge heavily out from ${his} body while threatening to snap the frayed cord keeping ${his} modesty rag up.`);
						}
					} else if (slave.weight > 190) {
						r.push(`${slave.slaveName}'s massively fat belly takes full advantage of ${his} exposed midriff to hang and jiggle freely while obscuring ${his} modesty rag.`);
					} else if (slave.belly >= 15000 || slave.bellyAccessory === "a huge empathy belly") {
						if (slave.bellyAccessory === "a huge empathy belly") {
							r.push(`${slave.slaveName}'s huge pregnant belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						} else if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s huge implant-filled belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						} else {
							r.push(`${slave.slaveName}'s huge pregnant belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						}
					} else if (slave.belly >= 10000 || slave.bellyAccessory === "a large empathy belly") {
						if (slave.bellyAccessory === "a large empathy belly") {
							r.push(`${slave.slaveName}'s big pregnant belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						} else if (isBellyFluidLargest) {
							r.push(`${slave.slaveName}'s hugely swollen belly takes full advantage of ${his} exposed midriff to bulge freely and obscure ${his} modesty rag.`);
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s big implant-filled belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						} else {
							r.push(`${slave.slaveName}'s big pregnant belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
						}
					} else if (slave.weight > 160) {
						r.push(`${slave.slaveName}'s hugely fat belly takes full advantage of ${his} exposed midriff to hang and jiggle freely while obscuring ${his} modesty rag.`);
					} else if (slave.weight > 130) {
						r.push(`${slave.slaveName}'s big fat belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
					} else if (slave.belly >= 5000 || slave.bellyAccessory === "a medium empathy belly") {
						if (slave.bellyAccessory === "a medium empathy belly") {
							r.push(`${slave.slaveName}'s pregnant belly takes full advantage of ${his} exposed midriff to bulge freely and slightly obscure ${his} modesty rag.`);
						} else if (isBellyFluidLargest) {
							r.push(`${slave.slaveName}'s jiggling ${slave.inflationType}-filled belly takes full advantage of ${his} exposed midriff to bulge freely and slightly obscure ${his} modesty rag.`);
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s implant-filled belly takes full advantage of ${his} exposed midriff to bulge freely and slightly obscure ${his} modesty rag.`);
						} else {
							r.push(`${slave.slaveName}'s pregnant belly takes full advantage of ${his} exposed midriff to bulge freely and slightly obscure ${his} modesty rag.`);
						}
					} else if (slave.weight > 95) {
						r.push(`${slave.slaveName}'s fat belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
					} else if (slave.belly >= 1500 || slave.bellyAccessory === "a small empathy belly") {
						if (slave.bellyAccessory === "a small empathy belly") {
							r.push(`${slave.slaveName}'s small pregnant belly takes full advantage of ${his} exposed midriff to bulge freely.`);
						} else if (isBellyFluidLargest) {
						...
						r.push(`${slave.slaveName}'s chubby belly takes full advantage of ${his} exposed midriff to hang freely and obscure ${his} modesty rag.`);
					} else if (slave.bellyPreg >= 100 || slave.bellyImplant >= 100) {
						r.push(`${slave.slaveName}'s crotch rag dangles just beneath the slight swell of ${his} lower belly, rendering it completely obvious.`);
					} else if (slave.muscles > 30) {
						r.push(`${slave.slaveName}'s ripped abs are prominently displayed for all to see.`);
					}
					break;
				case "a slutty magical girl costume":
					if (slave.belly >= 1000000) {
					// WIP//
					} else if (slave.belly >= 750000) {
						if (isBellyFluidLargest) {
							...
							r.push(`${slave.slaveName}'s narrow bodysuit is stretched to its absolute limit trying to contain the swell of ${his} monolithic implant-filled belly. The material tightly clings to what little it can still cover, prominently displaying ${his} popped navel, and only covers the center of ${his} gravidity, leaving ${his} expansive sides completely exposed. ${His} skirt still somehow manages to reach all the way around the excessive mass, implying this transformation may be ${his} fully developed form.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit is stretched to its absolute limit trying to contain the swell of ${his} monolithic pregnant belly. The material tightly clings to what little it can still cover, prominently displaying ${his} popped navel and the prominent bulges of the children filling ${his} womb, but only covers the center of ${his} gravidity, leaving ${his} bulging sides completely exposed. ${His} skirt still somehow manages to reach all the way around the monstrous, uneven mass, implying this transformation may be ${his} fully developed form.`);
						}
					} else if (slave.bellyPreg >= 600000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit threatens to burst under the strain of ${his} titanic implant-filled belly. The material tightly clings to what it can still cover, prominently displaying ${his} popped navel, and only covers the center of ${his} gravidity, leaving ${his} sides completely exposed. ${His} skirt still somehow manages to hold on around the ponderous mass, suggesting this transformation may have been fated.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit threatens to burst under the strain of ${his} titanic pregnant belly. The material tightly clings to what it can still cover, prominently displaying ${his} popped navel and the bulges of ${his} unborn children, but only covers the center of ${his} gravidity, leaving ${his} rather lumpy sides completely exposed. ${His} skirt still somehow manages to hold on around the ponderous mass, suggesting this transformation may have been fated.`);
						}
					} else if (slave.belly >= 450000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit is beginning to meet its match against ${his} gigantic implant-filled belly, tightly clinging to what it can still cover and prominently displaying ${his} popped navel. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt struggles to stretch all the way around ${his} bulk.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit is beginning to meet its match against ${his} gigantic pregnant belly, tightly clinging to what it can still cover and prominently displaying ${his} popped navel and the numerous faint outlines pushing against ${his} skin. ${His} skirt struggles to stretch all the way around ${his} bulk and threatens to snap off when ${his} stomach begins to squirm.`);
						}
					} else if (slave.bellyPreg >= 300000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches to an incredible degree to contain ${his} massive implant-filled belly, tightly clinging to what it can cover and prominently displaying ${his} popped navel. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the impressive bulge, as if this transformation was destined.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches to an incredible degree to contain ${his} massive pregnant belly, while displaying every kick and movement within. The material tightly clings to what it can cover, prominently displaying ${his} popped navel and every kick and squirm beneath it. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the impressive bulge, as if this transformation was destined.`);
						}
					} else if (slave.belly >= 150000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches impressively to contain ${his} giant implant-filled belly, tightly clinging to what it can cover and prominently displaying ${his} popped navel. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the bulge, as if this transformation was expected.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches impressively to contain ${his} giant pregnant belly. The material tightly clings to what it can cover, prominently displaying ${his} popped navel and every kick and squirm beneath it. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the bulge, as if this transformation was expected.`);
						}
					} else if (slave.belly >= 120000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches to contain the swell of ${his} giant implant-filled belly, tightly clinging to what it can cover and prominently displaying ${his} popped navel. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the bulge, as if this transformation was expected.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit stretches to contain the swell of ${his} giant pregnant belly. The material tightly clings to what it can cover, prominently displaying ${his} popped navel and every kick and squirm beneath it. The sides of ${his} gravidity are completely exposed by the garment, while ${his} skirt casually stretches all the way around the bulge, as if this transformation was expected.`);
						}
					} else if (slave.belly >= 30000) {
						if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit embraces the curve of ${his} huge implant-filled belly, clearly displaying ${his} popped navel. The material tightly clings to the center of ${his} gravidity, leaving ${his} sides completely exposed, while ${his} skirt stretches all the way around the bulge, as if it were expected that ${he}'d grow heavy with child.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit embraces the curvee of ${his} huge pregnant belly, displaying every kick and squirm within it. The material tightly clings to ${his} popped navel, but only covers the center of ${his} gravidity, leaving ${his} sides completely exposed, while ${his} skirt stretches all the way around the bulge, as if it were expected that ${he}'d grow heavy with child.`);
						}
					} else if (slave.weight > 190) {
						r.push(`${slave.slaveName}'s narrow bodysuit shows off every wiggle and jiggle within ${his} massively fat belly. The material tightly clings to ${his} soft mass, forming a deep cleft in what little it can actually cover, while the rest spills out its sides, only kept in check by ${his} skirt sinking into it.`);
					} else if (slave.belly >= 15000 || slave.bellyAccessory === "a huge empathy belly") {
						if (slave.bellyAccessory === "a huge empathy belly") {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} huge pregnant belly. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches all the way around the bulge, as if it were expected that ${he}'d grow heavy with child.`);
						} else if (isBellyFluidLargest) {
							// TODO: write me
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} huge implant-filled belly. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches all the way around the bulge, as if it were expected that ${he}'d grow big and round.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} huge pregnant belly, while displaying every kick and movement within. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches all the way around the bulge, as if it were expected that ${he}'d grow heavy with child.`);
						}
					} else if (slave.belly >= 10000 || slave.bellyAccessory === "a large empathy belly") {
						if (slave.bellyAccessory === "a large empathy belly") {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} big pregnant belly. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches around the bulge, as if ${he} never got the chance to adjust it.`);
						} else if (isBellyFluidLargest) {
							r.push(`${slave.slaveName}'s narrow bodysuit pushes uncomfortably against ${his} hugely swollen belly, forcing a large amount of it out the sides of the garment. ${His} skirt wraps around the ${slave.inflationType}-filled balloon, lewdly causing it to bulge above and below it as well.`);
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} big implant-filled belly. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches around the bulge, as if ${he} never got the chance to adjust it.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit highlights the curvature of ${his} big pregnant belly, while displaying every kick and movement within. The material tightly clings to ${his} popped navel and shows a lot of skin through the sides. ${His} skirt stretches around the bulge, as if ${he} never got the chance to adjust it.`);
						}
					} else if (slave.weight > 160) {
						r.push(`${slave.slaveName}'s narrow bodysuit tightly clings to ${his} hugely fat belly, clearly displaying every fold, roll and motion in what little of its mass it actually holds. ${His} skirt is left to sink deep into the succulent flesh.`);
					} else if (slave.weight > 130) {
						r.push(`${slave.slaveName}'s narrow bodysuit tightly clings to ${his} big fat belly, clearly displaying every fold and roll as it spills out its sides, while ${his} skirt sinks deep into the succulent flesh.`);
					} else if (slave.belly >= 5000 || slave.bellyAccessory === "a medium empathy belly") {
						if (slave.bellyAccessory === "a medium empathy belly") {
							r.push(`${slave.slaveName}'s narrow bodysuit shows off the curvature of ${his} pregnant belly. ${His} skirt wraps around the bulge, just below the navel.`);
						} else if (isBellyFluidLargest) {
							r.push(`${slave.slaveName}'s narrow bodysuit hugs ${his} jiggling ${slave.inflationType}-filled belly, forcing it to be a little flatter than it would be. ${His} skirt wraps around the bloated bulge, just below the navel.`);
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit shows off the curvature of ${his} implant-filled belly. ${His} skirt wraps around the bulge, just below the navel.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit shows off the curvature of ${his} pregnant belly, displaying every kick and movement within. ${His} skirt wraps around the bulge, just below the navel, steadily covering even less.`);
						}
					} else if (slave.weight > 95) {
						r.push(`${slave.slaveName}'s narrow bodysuit tightly clings to ${his} fat belly, clearly displaying every fold and roll as it spills out its sides, while ${his} skirt sinks into the succulent flesh.`);
					} else if (slave.belly >= 1500 || slave.bellyAccessory === "a small empathy belly") {
						if (slave.bellyAccessory === "a small empathy belly") {
							r.push(`${slave.slaveName}'s narrow bodysuit bulges with ${his} small pregnant belly. ${His} skirt covers even less as it gets pushed further out from ${his} body.`);
						} else if (isBellyFluidLargest) {
							r.push(`${slave.slaveName}'s narrow bodysuit bulges with ${his} ${slave.inflationType}-swollen belly while ${his} skirt slightly sinks into it.`);
						} else if (slave.bellyImplant > 0) {
							r.push(`${slave.slaveName}'s narrow bodysuit bulges with ${his} implant-rounded belly. ${His} skirt covers even less as it gets pushed further out from ${his} body.`);
						} else {
							r.push(`${slave.slaveName}'s narrow bodysuit bulges with ${his} growing belly. ${His} skirt covers even less as it gets pushed further out from ${his} body.`);
						}
					} else if (slave.weight > 30) {
						r.push(`${slave.slaveName}'s narrow bodysuit clings to ${his} chubby belly, clearly displaying every fold and roll.`);
					} else if (slave.bellyPreg >= 100 || slave.bellyImplant >= 100) {
						r.push(`${slave.slaveName}'s narrow bodysuit clings to ${his} belly, clearly displaying the slight swell above ${his} skirt.`);
					} else if (slave.muscles > 30) {
						r.push(`${slave.slaveName}'s narrow bodysuit hugs ${his} ripped abs, clearly displaying every powerful motion they make.`);
					}
					break;
				// WIP
				case "a superhero outfit":
				case "a streetwear outfit":
				case "a leather outfit":
				case "a tribal outfit":
				case "a tropical outfit":
				case "a valkyrie outfit":
				case "a coat and corset":
				case "a babydoll":
				case "a baroque dress":
				case "a country outfit":
				case "a cocktail dress":
				case "an ice queen outfit":
				case "a magical girl costume":
				case "a sundress":
				case "a red priestess outfit":
				case "an eastern european outfit":
				case "a wedding dress":
				case "an armored dress":
				case "a frilly bikini":
				case "a samba outfit":
				case "a cardigan":
				case "a turtleneck and miniskirt":
					break;
			}
		}

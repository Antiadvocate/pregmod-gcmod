...
App.Desc.ears = function(slave) {
	...
	if (slave.earT === "cat") {
		...
		r.push(`On top of ${his} head ${he} has a pair of round`);
		if (slave.earTColor !== "hairless" && slave.earTEffect !== "none") {
			r.push(`and fluffy ${slave.earTColor} colored spotted hyena ears that have ${slave.earTEffect} on them; they`);
		} else if (slave.earTColor !== "hairless" && slave.earTEffect === "none") {
			r.push(`and fluffy ${slave.earTColor} colored spotted hyena ears; they`);
		} else {
			r.push(`${slave.earTColor} spotted hyena ears; they`);
		}
		topEarsPerkUp();
		topEarsDroopTwitch();
	} else if (slave.earT === "pointy hyena") {
		r.push(`On top of ${his} head ${he} has a pair of pointy, rhombus-like`);
		if (slave.earTColor !== "hairless" && slave.earTEffect !== "none") {
			r.push(`${slave.earTColor} colored hyena ears that have ${slave.earTEffect} on them; they`);
		} else {
			r.push(`${slave.earTColor} hyena ears; they`);
		}
		topEarsPerkUp();
		topEarsDroopTwitch();
		...
		r.push (`On top of ${his} head ${he} has a pair of small and round,`);
		if (slave.earTColor !== "hairless" && slave.earTEffect !== "none") {
			r.push(`${slave.earTColor} colored rat ears that have ${slave.earTEffect} on them; they`);
		} else {
			r.push(`${slave.earTColor} rat ears; they`);
		}
		topEarsPerkUp();
		topEarsDroopTwitch();
	} else if (slave.earT === "mouse") {
		r.push (`On top of ${his} head ${he} has a pair of large and round,`);
		if (slave.earTColor !== "hairless" && slave.earTEffect !== "none") {
			r.push(`${slave.earTColor} colored mouse ears that have ${slave.earTEffect} on them; they`);
		} else {
			r.push(`${slave.earTColor} mouse ears; they`);
		}
		topEarsPerkUp();
		topEarsDroopTwitch();

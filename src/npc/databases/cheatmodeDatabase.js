...
/**
 * Creates the starting slaves for cheat mode.
 * These slaves should stay as close to how they were original defined as possible
 * @returns {string}
 */
App.Intro.cheatModeSlaves = function() {
	const slaveNames = [];

	if (V.temp.newCheatGirls) {
		// pick 3-6 random hero slaves instead of using the tradition cheat mode slaves
	...
	let cheatSlave = clone(templateSlave);
	...
	cheatSlave = clone(templateSlave);

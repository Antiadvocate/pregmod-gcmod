App.Facilities.Brothel.brothel = class Brothel extends App.Facilities.Facility {
	...
	get decorations() {
		...
		const FS = {
			...
			"Antebellum Revivalist": `is furnished as an old-fashioned Southern bordello, all dark wood and red velvet. Corseted courtesans fan themselves languidly in the foyer as they entice their customers.`,

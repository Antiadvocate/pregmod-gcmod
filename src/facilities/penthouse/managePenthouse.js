...
App.UI.managePenthouse = function() {
	...
	function major() {
		...
		if (!App.Entity.facilities.servantsQuarters.established) {
			App.UI.DOM.appendNewElement("div", el, makeLink("Build a dormitory to house large numbers of house servants", () => {
				App.Entity.facilities.servantsQuarters.capacity = 5;
			}));
		} else {

...
App.Data.WardrobeShopping.Clothing = {
	...
	other: {
		...
		"newmisc": {
			title: "a large crate of new miscellaneous clothing. WIP - For use with AI-Art Generation",
			cost: 15000,
			contains: ["a superhero outfit", "a cardigan", "a streetwear outfit", "a country outfit", "a leather outfit", "a turtleneck and miniskirt", "a sundress", "an eastern european outfit", "a samba outfit", "a tribal outfit", "a tropical outfit", "a valkyrie outfit",
				"a red priestess outfit", "a baroque dress", "a cocktail dress", "an ice queen outfit", "a magical girl costume", "a wedding dress", "an armored dress", "a babydoll", "a coat and corset", "a frilly bikini"],
			get requirements() { return V.imageChoice === 6; },
			owned: "You now own a wide range of clothing choices for every opportunity.",
		},
	}
};
/**

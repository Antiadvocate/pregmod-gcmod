App.Medicine.Surgery.Reactions.Desmell = class extends App.Medicine.Surgery.SimpleReaction {
	/**
...
App.Medicine.Surgery.Procedures.Desmell = class extends App.Medicine.Surgery.Procedure {
	get name() {
		return "Remove sense of smell";
	}
	...
	apply(cheat) {
		this._slave.smells = -1;
		return this._assemble(new App.Medicine.Surgery.Reactions.Desmell());
	}
};

App.Medicine.Surgery.Reactions.Resmell = class extends App.Medicine.Surgery.SimpleReaction {
	/**
	 * @param {FC.SlaveState} slave
	 * @param {Partial<FC.SlaveState>} diff
	 * @returns {reactionResult}
...
App.Medicine.Surgery.Procedures.Resmell = class extends App.Medicine.Surgery.Procedure {
	get name() {
		return "Repair sense of smell";
	}
	...
	apply(cheat) {
		this._slave.smells = 0;
		return this._assemble(new App.Medicine.Surgery.Reactions.Resmell());
	}
};

...
App.Medicine.Surgery.Procedures.buttImplantsProcedure = function() {
	 ...
	 * @param {FC.SlaveState} slave
	 */
	const applyButtChange = (slave) => {
		if (!["fillable", "advanced fillable", "hyper fillable"].includes(slave.buttImplantType) && ["all", "TnA", "bottomHeavy", "buttImplant"].includes(slave.cervixImplantTarget)) {

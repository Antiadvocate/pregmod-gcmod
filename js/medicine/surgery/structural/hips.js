...
App.Medicine.Surgery.Procedures.BroadenPelvis = class extends App.Medicine.Surgery.Procedure {
	get name() { return this._slave.hipsImplant === 0 ? "Broaden pelvis" : "Advanced pelvis broadening"; }

	get healthCost() { return 40; }

	get _blockedByFacilityControlledAspect() {
		return FacilityControlledAspect.SURGERY_HIPS;
	}
...
App.Medicine.Surgery.Procedures.NarrowPelvis = class extends App.Medicine.Surgery.Procedure {
	get name() { return this._slave.hipsImplant === 0 ? "Narrow pelvis" : "Advanced pelvis narrowing"; }

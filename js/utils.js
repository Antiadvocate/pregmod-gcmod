...
/**
 * Takes a given string and converts it to title case.
 * "hello world" -> "Hello World".
 * "7th time's the charm for jim-bob" -> "7th Time's The Charm For Jim-Bob".
 * "ØSTER HUS AS" -> "Øster Hus As".
 * "f" -> "F".
 * Taken from https://stackoverflow.com/questions/196972/convert-string-to-title-case-with-javascript#comment138081811_196991 and converted into a function
 * @param {string} str
 * @returns {string}
 */

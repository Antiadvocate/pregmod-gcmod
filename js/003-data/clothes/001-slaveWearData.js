...
App.Data.clothes = (new Map())
	...
	.set("a slutty magical girl costume",
		{
			name: "Magical girl costume (hentai)",
			exposure: 2,
			get requirements() { return (V.boughtItem.clothing.costume === 1); },
		}
	)

	// Begin NewMisc Outfits --- All outfits are WIP, missing descriptions and are intended to use with AI-Art Generation
	.set("a superhero outfit",
		{
			name: "Superhero outfit",
			exposure: 1,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
		}
	)
	.set("a cardigan",
		{
	...
	.set("a country outfit",
		{
			name: "Country girl outfit",
			exposure: 1,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
		}
	)
	.set("a leather outfit",
		{
			name: "Leather outfit",
			exposure: 2,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
	...
	.set("a turtleneck and miniskirt",
		{
	...
	.set("an eastern european outfit",
		{
			name: "Eastern european outfit",
			exposure: 0,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
		}
	)
	...
	.set("a red priestess outfit",
		{
			name: "Red priestess outfit",
			exposure: 0,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
		}
	)
	...
	.set("a coat and corset",
		{
			name: "Coat and corset",
			exposure: 2,
			get requirements() { return (V.boughtItem.clothing.newmisc === 1); },
		}
	)
	...
	.set("slave rags",
		{
			...
			exposure: 3,
			note: "Increases fear for resistant slaves and devotion for self-haters."
		}
	);

...
App.Data.SlaveSummary = {
	long: {
		...
		clothes: {
			...
			// WIP
			"a superhero outfit": "Superhero Outfit",
			"a cardigan": "Cardigan",
			"a streetwear outfit": "Streetwear",
			"a country outfit": "Country Girl",
			"a leather outfit": "Leather Outfit",
			"a turtleneck and miniskirt": "Turtleneck",
			"a red priestess outfit": "Red Priestess",
			"an eastern european outfit": "Eastern Europe",
			"a samba outfit": "Samba",
			"a tribal outfit": "Tribal",
			"a tropical outfit": "Tropical",
			"a valkyrie outfit": "Valkyrie",
			"a baroque dress": "Baroque Dress",
			"a cocktail dress": "Cocktail Dress",
			"an ice queen outfit": "Ice Queen",
			"a magical girl costume": "Magical Girl",
			"a slutty magical girl costume": "Hentai Girl",
			"a sundress": "Sundress",
			"a wedding dress": "Wedding Dress",
			"an armored dress": "Armored Dress",
			"a babydoll": "Babydoll",
			"a coat and corset": "Coat and Lingerie",
			"a frilly bikini": "Frilly Bikini",
